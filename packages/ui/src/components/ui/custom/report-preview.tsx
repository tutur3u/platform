            ...
            <div className="border-foreground/50 my-4 flex flex-col justify-stretch rounded border-2 text-sm md:flex-row">
              {getConfig('REPORT_CONTENT_TEXT') && (
                <div className="md:flex-[2]">
                  ...
                  <div
                    className={`border-foreground/50 min-h-[6rem] text-ellipsis whitespace-pre-line break-words border-t-2 p-2 font-semibold ${
              ...
              {getConfig('REPORT_SCORE_TEXT') && (
                <div className="border-foreground/50 flex-[1]">
                  ...
                  <div className="border-foreground/50 flex min-h-[6rem] justify-center text-ellipsis whitespace-pre-line break-words border-t-2 p-2 text-center">
                    <span
                      className={
                        data?.score
