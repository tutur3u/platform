  ...
  (
    ...
    return (
      <textarea
        ...
        ref={textAreaRef}
        className={cn(
          'scrollbar-none flex w-full overflow-auto rounded-md border border-input bg-background px-3 py-2 text-sm outline-hidden ring-0 ring-transparent placeholder:text-muted-foreground focus-visible:outline-hidden focus-visible:ring-0 focus-visible:ring-transparent focus-visible:ring-offset-0 disabled:cursor-not-allowed disabled:opacity-50',
          className
        )}
        onChange={(e) => {
