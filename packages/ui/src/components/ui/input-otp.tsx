...
function InputOTPSlot({
  ...
  return (
    <div
      ...
      className={cn(
        'border-input ring-ring/10 dark:ring-ring/20 dark:outline-ring/40 outline-ring/50 shadow-xs relative flex h-9 w-9 items-center justify-center border-y border-r text-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md data-[active=true]:z-10 data-[active=true]:outline-1 data-[active=true]:ring-4',
        className
      )}
      {...props}
    >
