...
// Reusable minimal task card component
...
export function LightweightTaskCard({
  ...
  if (isMinimalMode) {
    return (
      <MinimalTaskCard
        task={task}
        className="pointer-events-none w-full max-w-[350px] scale-105 select-none border-2 border-primary/20 bg-background opacity-95 shadow-xl ring-2 ring-primary/20"
      />
    );
  }
