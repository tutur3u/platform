...
vi.mock('@tuturuuu/ui/tu-do/shared/progressive-loader-context', () => ({
  ProgressiveLoaderProvider: ({ children }: any) => (
    <div data-testid="progressive-loader">{children}</div>
  ),
}));

vi.mock('@tuturuuu/ui/tu-do/shared/board-header', () => ({
...
vi.mock('@tuturuuu/ui/tu-do/boards/boardId/kanban', () => ({
...
vi.mock('@tuturuuu/ui/tu-do/shared/list-view', () => ({
  ListView: (props: any) => {
...
vi.mock('@tuturuuu/ui/tu-do/boards/boardId/timeline-board', () => ({
