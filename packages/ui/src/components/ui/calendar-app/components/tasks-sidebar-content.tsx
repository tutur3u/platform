...
interface TasksSidebarContentProps {
  ...
  /** Optional Chat component to render in the AI Chat tab. If not provided, the tab will show a placeholder. */
  ChatComponent?: ComponentType<ChatComponentProps>;
}
