...
export function PromotionCard({ promotion, locale }: PromotionCardProps) {
    ...
    const isHighValue = isPercentage ? promotion.value > 20 : promotion.value > 100000
                ...
                <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3 flex-1">
                        ...
                        <div className="flex-1 min-w-0">
                            <h4 className="font-semibold text-card-foreground text-sm truncate">{displayName}</h4>
                            <div className="flex items-center gap-2 mt-1">
                                <Badge variant={isPercentage ? "default" : "secondary"} className="text-xs px-2 py-0.5">
                    ...
                    <div className="text-right">
                        ...
                        <div className="text-xs text-muted-foreground">{isPercentage ? "Discount" : "Off"}</div>
                    </div>
                </div>
            </CardContent>
        </Card>
