...
export default function StickyBottomIndicator() {
  ...
  return (
    <div className="fixed right-0 bottom-2 left-0 z-50 rounded-2xl bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 md:right-auto md:left-1/2 md:-translate-x-1/2">
