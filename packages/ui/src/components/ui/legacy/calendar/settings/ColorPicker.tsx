...
// Color map with display names and CSS classes - Added cbg = circle background
export const colorMap: Record<
  SupportedColor,
  { bg: string; cbg: string; activeBg: string; text: string; name: string }
> = {
  RED: {
