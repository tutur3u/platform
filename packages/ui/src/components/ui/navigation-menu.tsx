...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn(
        'flex flex-col gap-1 rounded-sm p-2 text-sm outline-ring/50 ring-ring/10 transition-[color,box-shadow] [&_svg:not([class*= hover:bg-accent hover:text-accent-foreground focus:bg-accent focus:text-accent-foreground focus-visible:outline-1 focus-visible:ring-4 data-[active=true]:bg-accent/50 data-[active=true]:text-accent-foreground dark:outline-ring/40 dark:ring-ring/20'size-'])]:size-4 [&_svg:not([class*='text-'])]:text-muted-foreground',
        className
      )}
      {...props}
    />
