      ...
      },
      {
        ...
        permissions: [
          ...
          },
          {
            id: 'use_ai_studio',
            icon: <Sparkles />,
            title: t('ws-roles.use_ai_studio'),
            description: t('ws-roles.use_ai_studio_description'),
            disableOnProduction: false,
            disabled: false,
          },
          {
            id: 'manage_ai_keys',
            icon: <KeyRound />,
            title: t('ws-roles.manage_ai_keys'),
            description: t('ws-roles.manage_ai_keys_description'),
            disableOnProduction: false,
            disabled: false,
          },
          {
            id: 'manage_ai_policy',
            icon: <Settings2 />,
            title: t('ws-roles.manage_ai_policy'),
            description: t('ws-roles.manage_ai_policy_description'),
            disableOnProduction: false,
            disabled: false,
          },
          {
            id: 'manage_ai_prompts',
            icon: <FileText />,
            title: t('ws-roles.manage_ai_prompts'),
            description: t('ws-roles.manage_ai_prompts_description'),
            disableOnProduction: false,
            disabled: false,
          },
          {
            id: 'manage_ai_agents',
            icon: <CircuitBoard />,
            title: t('ws-roles.manage_ai_agents'),
            description: t('ws-roles.manage_ai_agents_description'),
            disableOnProduction: false,
            disabled: false,
          },
          {
            id: 'manage_ai_evaluations',
            icon: <FlaskConical />,
            title: t('ws-roles.manage_ai_evaluations'),
            description: t('ws-roles.manage_ai_evaluations_description'),
            disableOnProduction: false,
            disabled: false,
          },
          {
            id: 'view_ai_usage',
            icon: <ChartBar />,
            title: t('ws-roles.view_ai_usage'),
            description: t('ws-roles.view_ai_usage_description'),
            disableOnProduction: false,
            disabled: false,
          },
          {
            id: 'view_ai_logs',
            icon: <ScrollText />,
            title: t('ws-roles.view_ai_logs'),
            description: t('ws-roles.view_ai_logs_description'),
            disableOnProduction: false,
            disabled: false,
          },
        ],
