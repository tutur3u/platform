...
export const LAUNCHABLE_APPS = [
  ...
  {
    aliases: ['AI Studio', 'API', 'Models', 'Agents', 'Evaluations'],
    appRoot: 'apps/ai',
    category: 'ai',
    defaultPath: '/playground',
    localhostOrigin: 'http://localhost:7829',
    packageName: '@tuturuuu/ai-studio',
    portlessApp: 'ai',
    productionUrl: 'https://ai.tuturuuu.com',
    slug: 'ai',
    title: 'AI Studio',
    workspacePathResolver: workspaceRootPath,
  },
  ...
  {
    aliases: ['Surveys', 'Questionnaires', 'Responses', 'Form Builder'],
    appRoot: 'apps/forms',
    category: 'operations',
    defaultPath: '/personal',
    localhostOrigin: 'http://localhost:7828',
