...
export const WORKSPACE_SECRET_KEYS = {
  ...
  EMAIL_RATE_LIMIT_USER_MINUTE: 'EMAIL_RATE_LIMIT_USER_MINUTE',
  EMAIL_RATE_LIMIT_USER_HOUR: 'EMAIL_RATE_LIMIT_USER_HOUR',
  EMAIL_RATE_LIMIT_RECIPIENT_HOUR: 'EMAIL_RATE_LIMIT_RECIPIENT_HOUR',
  EMAIL_RATE_LIMIT_RECIPIENT_DAY: 'EMAIL_RATE_LIMIT_RECIPIENT_DAY',
  EMAIL_RATE_LIMIT_IP_MINUTE: 'EMAIL_RATE_LIMIT_IP_MINUTE',
  EMAIL_RATE_LIMIT_IP_HOUR: 'EMAIL_RATE_LIMIT_IP_HOUR',
