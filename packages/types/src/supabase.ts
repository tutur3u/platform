...
} | boolean | Json[] | null | number | string;
export type Database = {
    public: {
        ...
        Enums: {
            ai_message_type: "file" | "flashcards" | "message" | "multi_choice_quiz" | "notes" | "paragraph_quiz" | "summary";
            ...
            feature_flag: "ENABLE_AI" | "ENABLE_CHALLENGES" | "ENABLE_EDUCATION" | "ENABLE_QUIZZES";
            platform_service: "NOVA" | "REWISE" | "TUTURUUU" | "UPSKII";
            product: "calendar" | "drive" | "finance" | "mail" | "nova" | "other" | "qr" | "rewise" | "shortener" | "tudo" | "tumeet" | "web";
            promotion_type: "REFERRAL" | "REGULAR";
            recording_status: "completed" | "failed" | "interrupted" | "pending_transcription" | "recording" | "transcribing";
        ...
        Tables: {
            ...
            workspace_boards: {
                Insert: {
                    ...
                    creator_id?: null | string;
                    deleted?: boolean | null;
                    estimation_type?: Database["public"]["Enums"]["estimation_type"] | null;
...
} | keyof (DefaultSchema["Tables"] & DefaultSchema["Views"]), TableName extends DefaultSchemaTableNameOrOptions extends {
    schema: keyof DatabaseWithoutInternals;
...
export type TablesInsert<DefaultSchemaTableNameOrOptions extends {
    schema: keyof DatabaseWithoutInternals;
} | keyof DefaultSchema["Tables"], TableName extends DefaultSchemaTableNameOrOptions extends {
    schema: keyof DatabaseWithoutInternals;
...
export type Enums<DefaultSchemaEnumNameOrOptions extends {
    schema: keyof DatabaseWithoutInternals;
} | keyof DefaultSchema["Enums"], EnumName extends DefaultSchemaEnumNameOrOptions extends {
    schema: keyof DatabaseWithoutInternals;
...
export type CompositeTypes<PublicCompositeTypeNameOrOptions extends {
    schema: keyof DatabaseWithoutInternals;
} | keyof DefaultSchema["CompositeTypes"], CompositeTypeName extends PublicCompositeTypeNameOrOptions extends {
    schema: keyof DatabaseWithoutInternals;
