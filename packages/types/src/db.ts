...
export type WorkspaceForm = PrivateTable<'forms'>;
export type WorkspaceFormSection = PrivateTable<'form_sections'>;
export type WorkspaceFormQuestion = PrivateTable<'form_questions'>;
export type WorkspaceFormQuestionOption = PrivateTable<'form_question_options'>;
export type WorkspaceFormLogicRule = PrivateTable<'form_logic_rules'>;
export type WorkspaceFormShareLink = PrivateTable<'form_share_links'>;
export type WorkspaceFormSession = PrivateTable<'form_sessions'>;
export type WorkspaceFormResponse = PrivateTable<'form_responses'>;
export type WorkspaceFormResponseAnswer = PrivateTable<'form_response_answers'>;
