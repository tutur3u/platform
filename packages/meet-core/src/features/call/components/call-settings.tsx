...
import { MeetMemorySettings } from '@tuturuuu/meet-core/features/live-assistant/memory-settings';
import type { useMeetingAi } from '@tuturuuu/meet-core/features/meeting-ai/use-meeting-ai';
