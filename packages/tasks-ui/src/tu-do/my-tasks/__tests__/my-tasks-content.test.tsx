...
vi.mock(
  '@tuturuuu/tasks-ui/tu-do/boards/boardId/task-dialogs/TaskNewLabelDialog',
  () => ({
...
vi.mock(
  '@tuturuuu/tasks-ui/tu-do/boards/boardId/task-dialogs/TaskNewProjectDialog',
  () => ({
...
vi.mock('@tuturuuu/tasks-ui/tu-do/boards/form', () => ({
  TaskBoardForm: () => <div data-testid="task-board-form" />,
}));

vi.mock('@tuturuuu/tasks-ui/tu-do/shared/create-list-dialog', () => ({
