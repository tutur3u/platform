...
import TemplateDetailClient from '@tuturuuu/tasks-ui/tu-do/templates/templateId/client';
import type { BoardTemplateWithContent } from '@tuturuuu/tasks-ui/tu-do/templates/types';
