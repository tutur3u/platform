      ...
      <div className="relative">
        ...
        {isMultiCardDrag && (
          <>
            ...
            <div className="pointer-events-none absolute top-1 left-1 -z-10 h-full w-full rounded-lg border border-dynamic-blue/25 bg-dynamic-blue/5" />
            {selectedTasks.size > 2 && (
              <div className="pointer-events-none absolute top-2 left-2 -z-20 h-full w-full rounded-lg border border-dynamic-blue/15 bg-dynamic-blue/3" />
            )}
            {/* Badge showing count */}
            <div className="absolute -top-2 -right-2 flex h-7 w-7 items-center justify-center rounded-full bg-dynamic-blue text-white ring-2 ring-background">
