...
const TASK_CARD_ICON_TONE_CLASSES: Record<SupportedColor, string> = {
  BLUE: 'border-dynamic-blue/70 bg-dynamic-blue/5 text-dynamic-blue',
  CYAN: 'border-dynamic-cyan/70 bg-dynamic-cyan/5 text-dynamic-cyan',
  GRAY: 'border-dynamic-gray/70 bg-dynamic-gray/5 text-foreground',
  GREEN: 'border-dynamic-green/70 bg-dynamic-green/5 text-dynamic-green',
  INDIGO: 'border-dynamic-indigo/70 bg-dynamic-indigo/5 text-dynamic-indigo',
  ORANGE: 'border-dynamic-orange/70 bg-dynamic-orange/5 text-dynamic-orange',
  PINK: 'border-dynamic-pink/70 bg-dynamic-pink/5 text-dynamic-pink',
  PURPLE: 'border-dynamic-purple/70 bg-dynamic-purple/5 text-dynamic-purple',
  RED: 'border-dynamic-red/70 bg-dynamic-red/5 text-dynamic-red',
  YELLOW: 'border-dynamic-yellow/70 bg-dynamic-yellow/5 text-dynamic-yellow',
};
