...
![Overall migration progress](https://img.shields.io/static/v1?color=fb8c00&label=Overall&message=27.74%25+terminal&style=flat-square) ![Rust backend migration progress](https://img.shields.io/static/v1?color=cf222e&label=Rust+backend&message=12.5%25+terminal&style=flat-square) ![TanStack Start migration progress](https://img.shields.io/static/v1?color=1f6feb&label=TanStack+Start&message=72.76%25+terminal&style=flat-square)

| Track | Progress | Terminal | Migrated | Removed | Remaining |
| --- | --- | ---: | ---: | ---: | ---: |
| Overall | `[######--------------]` 27.74% | 294 / 1,060 | 275 | 19 | 766 |
| Rust backend | `[###-----------------]` 12.5% | 99 / 792 | 82 | 17 | 693 |
