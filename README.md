...
![Overall migration progress](https://img.shields.io/static/v1?color=fb8c00&label=Overall&message=30.01%25+terminal&style=flat-square) ![Rust backend migration progress](https://img.shields.io/static/v1?color=cf222e&label=Rust+backend&message=14.24%25+terminal&style=flat-square) ![TanStack Start migration progress](https://img.shields.io/static/v1?color=1f6feb&label=TanStack+Start&message=76.14%25+terminal&style=flat-square)

| Track | Progress | Terminal | Migrated | Removed | Remaining |
| --- | --- | ---: | ---: | ---: | ---: |
| Overall | `[######--------------]` 30.01% | 232 / 773 | 219 | 13 | 541 |
| Rust backend | `[###-----------------]` 14.24% | 82 / 576 | 71 | 11 | 494 |
| TanStack Start | `[###############-----]` 76.14% | 150 / 197 | 148 | 2 | 47 |
...
| --- | --- | ---: | ---: |
| api | `[##--------------]` 13.65% | 77 / 564 | 487 |
| page | `[############----]` 72.14% | 101 / 140 | 39 |
| layout | `[##############--]` 87.04% | 47 / 54 | 7 |
| cron | `[#####-----------]` 28.57% | 2 / 7 | 5 |
