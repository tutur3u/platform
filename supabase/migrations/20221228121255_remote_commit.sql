...
--
CREATE FUNCTION "public"."add_org_creator"() RETURNS "trigger" LANGUAGE "plpgsql" SECURITY DEFINER AS $$begin
...
--
CREATE FUNCTION "public"."add_task_board_creator"() RETURNS "trigger" LANGUAGE "plpgsql" SECURITY DEFINER AS $$begin
...
--
CREATE FUNCTION "public"."create_profile_for_new_user"() RETURNS "trigger" LANGUAGE "plpgsql" SECURITY DEFINER AS $$begin
...
--
CREATE FUNCTION "public"."delete_invite_when_accepted"() RETURNS "trigger" LANGUAGE "plpgsql" AS $$begin
...
--
CREATE FUNCTION "public"."get_user_tasks"("_board_id" "uuid") RETURNS TABLE(
    "id" "uuid",
    "name" "text",
    "description" "text",
    "priority" smallint,
...
--
CREATE FUNCTION "public"."is_list_accessible"("_list_id" "uuid") RETURNS boolean LANGUAGE "sql" SECURITY DEFINER AS $$
SELECT EXISTS (
        SELECT 1
        FROM task_lists tl
...
--
CREATE FUNCTION "public"."is_member_invited"("_user_id" "uuid", "_org_id" "uuid") RETURNS boolean LANGUAGE "sql" SECURITY DEFINER AS $$
SELECT EXISTS (
        SELECT 1
        FROM org_invites oi
...
--
CREATE FUNCTION "public"."is_org_member"("_user_id" "uuid", "_org_id" "uuid") RETURNS boolean LANGUAGE "sql" SECURITY DEFINER AS $$
SELECT EXISTS (
        SELECT 1
        FROM org_members om
...
--
CREATE FUNCTION "public"."is_task_accessible"("_task_id" "uuid") RETURNS boolean LANGUAGE "sql" SECURITY DEFINER AS $$
SELECT EXISTS (
        SELECT 1
        FROM tasks
...
--
CREATE FUNCTION "public"."is_task_board_member"("_user_id" "uuid", "_board_id" "uuid") RETURNS boolean LANGUAGE "sql" SECURITY DEFINER AS $$
SELECT EXISTS (
        SELECT 1
...
--
CREATE FUNCTION "public"."is_user_task_in_board"("_user_id" "uuid", "_task_id" "uuid") RETURNS boolean LANGUAGE "sql" SECURITY DEFINER AS $$
SELECT EXISTS (
        SELECT 1
        FROM task_board_members tbm,
            tasks,
...
--
CREATE TRIGGER "add_org_creator_tr"
AFTER
INSERT ON "public"."orgs" FOR EACH ROW EXECUTE FUNCTION "public"."add_org_creator"();
--
-- Name: task_boards add_task_board_creator_tr; Type: TRIGGER; Schema: public; Owner: postgres
--
CREATE TRIGGER "add_task_board_creator_tr"
AFTER
INSERT ON "public"."task_boards" FOR EACH ROW EXECUTE FUNCTION "public"."add_task_board_creator"();
--
...
AFTER
INSERT ON "public"."org_members" FOR EACH ROW EXECUTE FUNCTION "public"."delete_invite_when_accepted"();
--
...
--
CREATE POLICY "Enable all access for organization members" ON "public"."projects" TO "authenticated" USING (
...
--
CREATE POLICY "Enable delete for members of the task board" ON "public"."task_boards" FOR DELETE TO "authenticated" USING (
    "public"."is_task_board_member"("auth"."uid"(), "id")
);
--
-- Name: org_members Enable delete for organization members; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable delete for organization members" ON "public"."org_members" FOR DELETE TO "authenticated" USING (
    "public"."is_org_member"("auth"."uid"(), "org_id")
);
--
-- Name: org_invites Enable delete for organization members and current user; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable delete for organization members and current user" ON "public"."org_invites" FOR DELETE TO "authenticated" USING (
    (
        ("auth"."uid"() = "user_id")
...
--
CREATE POLICY "Enable delete for users based on user_id" ON "public"."orgs" FOR DELETE TO "authenticated" USING (
    (
        (
...
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."orgs" FOR
INSERT TO "authenticated" WITH CHECK (true);
--
-- Name: task_boards Enable insert for authenticated users only; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable insert for authenticated users only" ON "public"."task_boards" FOR
INSERT TO "authenticated" WITH CHECK (true);
--
-- Name: org_members Enable insert for invited members; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable insert for invited members" ON "public"."org_members" FOR
INSERT TO "authenticated" WITH CHECK (
        "public"."is_member_invited"("auth"."uid"(), "org_id")
    );
--
-- Name: org_invites Enable insert for organization members; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable insert for organization members" ON "public"."org_invites" FOR
INSERT TO "authenticated" WITH CHECK (
        (
            "public"."is_org_member"("auth"."uid"(), "org_id")
            AND (
                NOT "public"."is_org_member"("user_id", "org_id")
            )
        )
    );
--
...
INSERT TO "authenticated" WITH CHECK (
        (
            "public"."is_task_accessible"("task_id")
            AND "public"."is_user_task_in_board"("user_id", "task_id")
        )
    );
--
...
--
CREATE POLICY "Enable read access for members of the task board" ON "public"."task_board_members" FOR
SELECT TO "authenticated" USING (
        (
            ("user_id" = "auth"."uid"())
            AND "public"."is_task_board_member"("auth"."uid"(), "board_id")
        )
    );
--
-- Name: task_boards Enable read access for members of the task board; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable read access for members of the task board" ON "public"."task_boards" FOR
SELECT TO "authenticated" USING (
        "public"."is_task_board_member"("auth"."uid"(), "id")
    );
--
...
--
CREATE POLICY "Enable read access for organization members" ON "public"."org_members" FOR
SELECT TO "authenticated" USING (
        "public"."is_org_member"("auth"."uid"(), "org_id")
    );
--
...
--
CREATE POLICY "Enable read access for organization members and current user" ON "public"."org_invites" FOR
SELECT TO "authenticated" USING (
        (
            ("auth"."uid"() = "user_id")
            OR "public"."is_org_member"("auth"."uid"(), "org_id")
...
--
CREATE POLICY "Enable read access for organization members or invited members" ON "public"."orgs" FOR
SELECT TO "authenticated" USING (
        (
...
--
CREATE POLICY "Enable read access for the creator of the task board" ON "public"."task_boards" FOR
SELECT TO "authenticated" USING (("creator_id" = "auth"."uid"()));
--
...
SELECT TO "authenticated" USING ("public"."is_task_accessible"("task_id"));
--
-- Name: orgs Enable update for all organization members; Type: POLICY; Schema: public; Owner: postgres
--
CREATE POLICY "Enable update for all organization members" ON "public"."orgs" FOR
...
--
CREATE POLICY "Enable update for members of the task board" ON "public"."task_boards" FOR
UPDATE TO "authenticated" USING (
        "public"."is_task_board_member"("auth"."uid"(), "id")
    ) WITH CHECK (
        "public"."is_task_board_member"("auth"."uid"(), "id")
...
--
GRANT ALL ON FUNCTION "extensions"."algorithm_sign"(
        "signables" "text",
        "secret" "text",
        "algorithm" "text"
    ) TO "dashboard_user";
...
--
GRANT ALL ON FUNCTION "extensions"."sign"(
        "payload" "json",
        "secret" "text",
        "algorithm" "text"
    ) TO "dashboard_user";
...
--
GRANT ALL ON FUNCTION "extensions"."verify"(
        "token" "text",
        "secret" "text",
        "algorithm" "text"
    ) TO "dashboard_user";
...
--
REVOKE ALL ON TABLE "net"."_http_response"
FROM "supabase_admin";
REVOKE ALL ON TABLE "net"."_http_response"
FROM "postgres";
...
--
REVOKE ALL ON TABLE "net"."http_request_queue"
FROM "supabase_admin";
REVOKE ALL ON TABLE "net"."http_request_queue"
FROM "postgres";
