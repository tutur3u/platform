...
const root = resolve(output, 'linux-package');
...
Depends: libgtk-3-0t64, libsecret-1-0, libstdc++6, libc6 (>= 2.39), libasound2t64, libgstreamer1.0-0, libgstreamer-plugins-base1.0-0
