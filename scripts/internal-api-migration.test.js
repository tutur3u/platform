...
test('migrated shared hooks no longer import the deprecated Supabase browser client', () => {
  const migratedFiles = [
    ...
    'apps/teach/src/app/[locale]/(dashboard)/[wsId]/education/quiz-sets/[setId]/linked-modules/linker.tsx',
    'apps/teach/src/app/[locale]/(dashboard)/[wsId]/education/quiz-sets/[setId]/linked-modules/row-actions.tsx',
    'apps/teach/src/app/[locale]/(dashboard)/[wsId]/education/courses/[courseId]/modules/[moduleId]/content/content-editor.tsx',
    'apps/teach/src/app/[locale]/(dashboard)/[wsId]/education/courses/[courseId]/modules/[moduleId]/quizzes/client-quizzes.tsx',
    'apps/teach/src/app/[locale]/(dashboard)/[wsId]/education/courses/[courseId]/modules/[moduleId]/flashcards/client-flashcards.tsx',
    'apps/web/src/app/[locale]/(dashboard)/[wsId]/documents/[documentId]/document-editor.tsx',
    'apps/drive/src/app/[locale]/(dashboard)/[wsId]/drive/file-preview-dialog.tsx',
    'apps/drive/src/app/[locale]/(dashboard)/[wsId]/drive/row-actions.tsx',
    'apps/drive/src/app/[locale]/(dashboard)/[wsId]/drive/use-drive-queries.ts',
    ...
    'packages/tasks-ui/src/calendar/components/quick-task-dialog.tsx',
    'packages/tasks-ui/src/calendar/components/task-form.tsx',
    'packages/tasks-ui/src/calendar/components/task-list-form.tsx',
    ...
    'packages/tasks-ui/src/tu-do/boards/boardId/task-form.tsx',
    'packages/tasks-ui/src/tu-do/boards/workspace-projects-client-page.tsx',
    'packages/tasks-ui/src/tu-do/drafts/draft-convert-dialog.tsx',
    'packages/tasks-ui/src/tu-do/my-tasks/task-list-with-completion.tsx',
    'packages/tasks-ui/src/tu-do/my-tasks/use-my-tasks-state.ts',
    'packages/tasks-ui/src/tu-do/my-tasks/use-task-context-actions.ts',
...
test('CLI auth uses Tuturuuu-managed JWTs instead of Supabase Auth sessions', () => {
  ...
  assert.doesNotMatch(verifyRoute, /sessionKind:\s*'supabase'/);
  assert.match(refreshRoute, /verifyCliRefreshToken/);
  assert.match(refreshRoute, /createCliAppSession/);
  assert.doesNotMatch(
    refreshRoute,
    /createDetachedClient|auth\.refreshSession/
  );
  assert.doesNotMatch(crossAppServer, /generateLink|verifyOtp/);
});
