...
export function LearnerNavDock({
  ...
  return (
    <aside className="fixed inset-x-0 bottom-0 z-20 border-border border-t-2 bg-background pb-[env(safe-area-inset-bottom)] shadow-[0_-6px_0_var(--border)] md:inset-y-4 md:right-auto md:left-4 md:w-24 md:border-2 md:pb-0 md:shadow-[7px_7px_0_var(--border)]">
              ...
              <Tooltip key={item.key}>
                <TooltipTrigger asChild>
                  <Link
                    ...
                    className={cn(
                      'group flex h-14 min-w-20 shrink-0 flex-col items-center justify-center gap-1 border-2 border-transparent text-muted-foreground transition duration-200 hover:border-border hover:bg-dynamic-yellow/15 hover:text-foreground active:translate-x-0.5 active:translate-y-0.5 md:h-16 md:min-w-0',
                      isActive &&
