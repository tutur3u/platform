...
export const objectCatalog: HiveCatalogItem[] = [
  {
    ...
    footprint: { autoExpandTerrain: true, depth: 2, width: 2 },
    id: 'house',
    label: 'House',
    shortcut: 'H',
    tool: 'build',
  },
  {
    category: 'building',
    color: '#5aa1d8',
    description: 'Compact blue-roof home',
    id: 'cottage',
    label: 'Cottage',
    shortcut: 'D',
    tool: 'build',
  },
  {
    category: 'building',
    color: '#d98a5b',
    description: 'Tall residential building',
    footprint: { autoExpandTerrain: true, depth: 1, width: 1 },
    id: 'townhouse',
    label: 'Townhouse',
    shortcut: 'X',
    tool: 'build',
  },
  {
    category: 'building',
    color: '#c96f62',
    description: 'Large civic building for the settlement center',
    footprint: { autoExpandTerrain: true, depth: 2, width: 2 },
    id: 'civic-hall',
    label: 'Civic Hall',
    shortcut: 'Z',
  ...
  },
  {
    category: 'building',
    color: '#8f84c7',
    description: 'Vertical lookout tower',
    id: 'watchtower',
    label: 'Tower',
    tool: 'build',
  },
  ...
  },
  {
    ...
    footprint: { autoExpandTerrain: true, depth: 1, width: 2 },
    id: 'warehouse',
    label: 'Warehouse',
    shortcut: 'A',
    tool: 'build',
