...
export const Route = createFileRoute('/$locale/products/documents')({
  component: DocumentsProductPage,
  head: () =>
    createPageHead({
      description:
        'Collaborate on docs with AI-assisted workflows in Tuturuuu.',
    ...
    <div className="container mx-auto mt-8 flex max-w-6xl flex-col gap-6 px-3 py-16 lg:gap-14 lg:py-24">
      ...
      <div className="mb-16 text-center">
        ...
        <div className="mt-8 flex flex-col justify-center gap-4 sm:flex-row">
          <ProductLinkButton href="/login">Start writing</ProductLinkButton>
