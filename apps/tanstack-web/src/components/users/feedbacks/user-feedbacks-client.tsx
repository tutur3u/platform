...
import { RequireAttentionName } from './require-attention-name';
import { useInfiniteWorkspaceUserGroups } from './use-workspace-user-groups';
...
type WorkspaceUserOptionData = WorkspaceBasicUserRecord;
...
async function fetchWorkspaceUserById(wsId: string, userId: string) {
  return await getWorkspaceUser(wsId, userId);
}
