...
import { updateWorkspaceUserGroup } from '@tuturuuu/internal-api';
...
export default function EditEndDateDialog({
  ...
  const updateDatesMutation = useMutation({
    mutationFn: async (values: FormValues) => {
      ...
      // Forwarded-auth facade over PUT /api/v1/workspaces/:wsId/user-groups/:id
      // (replaces the legacy raw client-side fetch — disallowed in tanstack-web).
      await updateWorkspaceUserGroup(wsId, groupId, {
