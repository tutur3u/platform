...
import { InfrastructureStressTestControlPanel } from './control-panel';
import { formatDecimalNumber, formatDuration } from './formatters';
import { MetricBlock } from './metric-block';
import { useInfrastructureStressTestSnapshot } from './query-hooks';
import { InfrastructureStressTestRunSummary } from './run-summary';

export function InfrastructureStressTestsClient({
  locale,
  wsId,
}: {
  locale?: string;
