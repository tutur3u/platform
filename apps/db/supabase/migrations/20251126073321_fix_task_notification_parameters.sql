-- Fix missing parameters in notify_task_updated function call to create_notification
-- Adds p_email, p_code, p_created_by, p_scope, and p_priority parameters
...
COMMENT ON FUNCTION public.notify_task_updated IS 'Tracks task field changes including title, description, priority, dates (end_date, start_date), estimation_points, and completion status. Fixed to use correct column names and includes all required parameters for create_notification: p_email, p_code, p_created_by, p_scope, and p_priority.';
