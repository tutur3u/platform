...
alter table "public"."meet_together_plans" drop column "enable_to_edit";

alter table "public"."meet_together_plans" add column "enable_unknown_edit" boolean not null default true;
