drop policy "Enable all access for challenge manager" on "public"."nova_challenge_whitelists";

revoke delete on table "public"."nova_challenge_whitelists" from "anon";

revoke insert on table "public"."nova_challenge_whitelists" from "anon";

revoke references on table "public"."nova_challenge_whitelists" from "anon";

revoke select on table "public"."nova_challenge_whitelists" from "anon";

revoke trigger on table "public"."nova_challenge_whitelists" from "anon";

revoke truncate on table "public"."nova_challenge_whitelists" from "anon";

revoke update on table "public"."nova_challenge_whitelists" from "anon";

revoke delete on table "public"."nova_challenge_whitelists" from "authenticated";

revoke insert on table "public"."nova_challenge_whitelists" from "authenticated";

revoke references on table "public"."nova_challenge_whitelists" from "authenticated";

revoke select on table "public"."nova_challenge_whitelists" from "authenticated";

revoke trigger on table "public"."nova_challenge_whitelists" from "authenticated";

revoke truncate on table "public"."nova_challenge_whitelists" from "authenticated";

revoke update on table "public"."nova_challenge_whitelists" from "authenticated";

revoke delete on table "public"."nova_challenge_whitelists" from "service_role";

revoke insert on table "public"."nova_challenge_whitelists" from "service_role";

revoke references on table "public"."nova_challenge_whitelists" from "service_role";

revoke select on table "public"."nova_challenge_whitelists" from "service_role";

revoke trigger on table "public"."nova_challenge_whitelists" from "service_role";

revoke truncate on table "public"."nova_challenge_whitelists" from "service_role";

revoke update on table "public"."nova_challenge_whitelists" from "service_role";

alter table "public"."nova_challenge_whitelists" drop constraint "nova_challenge_whitelists_challenge_id_fkey";

alter table "public"."nova_challenge_whitelists" drop constraint "nova_challenge_whitelists_pkey";

drop index if exists "public"."nova_challenge_whitelists_pkey";

drop table "public"."nova_challenge_whitelists";
...
CREATE UNIQUE INDEX nova_challenge_whitelists_pkey ON public.nova_challenge_whitelisted_emails USING btree (challenge_id, email);

alter table "public"."nova_challenge_whitelisted_emails" add constraint "nova_challenge_whitelists_pkey" PRIMARY KEY using index "nova_challenge_whitelists_pkey";
