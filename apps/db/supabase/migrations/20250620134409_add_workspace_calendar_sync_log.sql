...
CREATE INDEX workspace_calendar_sync_log_google_account_id_idx ON public.workspace_calendar_sync_log USING btree (google_account_id);
...
CHECK (triggered_by IN ('active_sync', 'trigger_dev', 'manual'));
