...
alter table "public"."tasks" drop column "user_defined_priority";

alter table "public"."tasks" alter column "priority" set default 'normal'::task_priority;

alter table "public"."tasks" alter column "priority" set data type task_priority using "priority"::task_priority;
