...
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 14.5 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 12 hours',
    9000,
    '00000000-0000-0000-0000-000000000001',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 11 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 9 hours',
    7200,
    '00000000-0000-0000-0000-000000000002',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 8.5 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 7 hours',
    5400,
    '00000000-0000-0000-0000-000000000005',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '2 days - 14 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '2 days - 10 hours',
    14400,
    '00000000-0000-0000-0000-000000000001',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '3 days - 13 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '3 days - 11.5 hours',
    5400,
    '00000000-0000-0000-0000-000000000006',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '4 days - 15 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '4 days - 12.5 hours',
    9000,
    '00000000-0000-0000-0000-000000000001',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '5 days - 10 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '5 days - 8 hours',
    7200,
    '00000000-0000-0000-0000-000000000003',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '6 days - 13.5 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '6 days - 11 hours',
    9000,
    '00000000-0000-0000-0000-000000000004',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '14 days - 15 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '14 days - 12 hours',
    10800,
    '00000000-0000-0000-0000-000000000001',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '13 days - 9 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '13 days - 7.5 hours',
    5400,
    '00000000-0000-0000-0000-000000000002',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '10 days - 14 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '10 days - 9.5 hours',
    16200,
    '00000000-0000-0000-0000-000000000001',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '9 days - 11 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '9 days - 9 hours',
    7200,
    '00000000-0000-0000-0000-000000000005',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '8 days - 14.5 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '8 days - 11.5 hours',
    10800,
    '00000000-0000-0000-0000-000000000004',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '7 days - 8 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '7 days - 6.5 hours',
    5400,
    '00000000-0000-0000-0000-000000000003',
    NULL
);
...
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 15 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 12.5 hours',
    9000,
    '00000000-0000-0000-0000-000000000001',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 10 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 8 hours',
    7200,
    '00000000-0000-0000-0000-000000000005',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '3 days - 14 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '3 days - 11 hours',
    10800,
    '00000000-0000-0000-0000-000000000001',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '4 days - 8.5 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '4 days - 7 hours',
    5400,
    '00000000-0000-0000-0000-000000000002',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '5 days - 13 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '5 days - 11 hours',
    7200,
    '00000000-0000-0000-0000-000000000003',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '13 days - 15 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '13 days - 11.5 hours',
    12600,
    '00000000-0000-0000-0000-000000000001',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '10 days - 10 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '10 days - 7.5 hours',
    9000,
    '00000000-0000-0000-0000-000000000004',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '8 days - 13.5 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '8 days - 12 hours',
    5400,
    '00000000-0000-0000-0000-000000000006',
    NULL
);
...
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 14 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 11 hours',
    10800,
    '00000000-0000-0000-0000-000000000004',
    NULL
...
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 9.5 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '1 day - 8 hours',
    5400,
    '00000000-0000-0000-0000-000000000005',
    NULL
...
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '4 days - 15 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '4 days - 12 hours',
    10800,
    '00000000-0000-0000-0000-000000000004',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '3 days - 9 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '3 days - 7.5 hours',
    5400,
    '00000000-0000-0000-0000-000000000002',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '12 days - 13.5 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '12 days - 10 hours',
    12600,
    '00000000-0000-0000-0000-000000000004',
    NULL
);
SELECT insert_time_tracking_session_bypassed(
    ...
    NOW() AT TIME ZONE 'UTC' - INTERVAL '8 days - 13 hours',
    NOW() AT TIME ZONE 'UTC' - INTERVAL '8 days - 11 hours',
    7200,
    '00000000-0000-0000-0000-000000000003',
    NULL
);
