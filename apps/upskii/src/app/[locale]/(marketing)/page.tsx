            ...
            <div className="mx-auto max-w-6xl px-4">
              <div className="grid gap-12 md:grid-cols-2 md:items-center">
                ...
                >
                  ...
                  <h2 className="bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-3xl font-bold text-transparent md:text-4xl dark:from-purple-400 dark:to-indigo-400">
                ...
                >
                  <Card className="overflow-hidden border-indigo-200/50 bg-gradient-to-br from-white/80 to-indigo-50/80 shadow-lg shadow-indigo-500/10 backdrop-blur-sm dark:border-indigo-800/50 dark:from-gray-900/80 dark:to-indigo-950/80">
                    <div className="space-y-4 p-6">
                      <h3 className="bg-gradient-to-r from-purple-600 to-indigo-600 bg-clip-text text-xl font-bold text-transparent dark:from-purple-400 dark:to-indigo-400">
