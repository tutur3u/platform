    ...
    <section id="ai" className="relative w-full py-24">
      <div className="relative mx-auto max-w-6xl px-4">
        <div className="mb-16 text-center">
          <Badge
            variant="outline"
            className="mb-4 inline-flex items-center gap-1 border-primary/30 bg-gradient-to-r from-blue-500/10 to-purple-500/10 text-primary backdrop-blur-sm"
          >
        ...
        <div className="mb-16 grid gap-8 lg:grid-cols-2">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {features.map((feature, index) => (
                <motion.div
                  ...
                  className="group"
                >
                  <Card className="relative overflow-hidden border-primary/20 bg-gradient-to-br from-white/50 to-gray-50/30 backdrop-blur-sm transition-all duration-300 hover:border-primary/40 hover:shadow-lg hover:shadow-primary/10 dark:from-gray-900/50 dark:to-gray-800/30">
          ...
          >
            ...
            {/* Decorative elements */}
            <motion.div
              className="-right-12 -top-12 absolute h-24 w-24"
              animate={{
                scale: [1, 1.1, 1],
                rotate: [0, 90, 0],
              }}
        ...
        >
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-700 dark:to-purple-700" />
