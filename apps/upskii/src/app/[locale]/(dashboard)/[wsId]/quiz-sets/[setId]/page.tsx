        ...
        <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <Link
              ...
              href={`/${wsId}/quiz-sets/${setId}/edit-set`}
            >
              <Button className="w-full bg-dynamic-purple/20 text-primary hover:bg-dynamic-purple/40">
                <Edit className="mr-2 h-4 w-4" />
                {t('ws-quiz-sets.edit')}
              </Button>
            </Link>
            <Link href={`/${wsId}/quiz-sets/${setId}/quiz-create`}>
              <Button className="w-full bg-dynamic-purple text-primary-foreground hover:bg-dynamic-purple/90 lg:w-fit">
            ...
            <Link href={`/${wsId}/quiz-sets/${setId}/quiz-edit`}>
              <Button
                variant="outline"
                className="w-full border-dynamic-purple text-dynamic-purple hover:bg-dynamic-purple/10 lg:w-fit"
              >
                <Edit className="mr-2 h-4 w-4" />
          ...
          <CardContent className="p-6">
            {quizCount > 0 ? (
              ...
              <div className="py-12 text-center">
                ...
                <Link href={`/${wsId}/quiz-sets/${setId}/quiz-create`}>
                  <Button className="bg-dynamic-purple text-primary-foreground hover:bg-dynamic-purple/90">
                    <Plus className="mr-2 h-4 w-4" />
