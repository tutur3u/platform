  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div
          className="blob blob-secondary w-80 h-80 top-1/2 -right-40 animate-float"
          style={{ animationDelay: '2s' }}
        />
        <div
          className="blob blob-primary w-64 h-64 bottom-20 left-1/4 animate-float"
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <p
            className="text-xl md:text-2xl text-primary font-semibold mb-4 animate-slide-up"
          ...
          <p
            className="max-w-2xl mx-auto text-lg text-text-muted mb-8 animate-slide-up"
          ...
          <div
            className="glass inline-block px-8 py-4 rounded-2xl animate-slide-up"
      ...
      <section
        id="about"
        className="section bg-secondary/10 dark:bg-secondary/5"
      >
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div
                key={index}
                className="text-center p-6 glass-card rounded-xl card-hover"
              >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            {[
              ...
              <div
                key={index}
                className="glass-card rounded-2xl p-6 flex items-center gap-6 card-hover"
              >
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="glass-card rounded-2xl p-8">
              <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
                <span className="w-10 h-10 gradient-bg rounded-lg flex items-center justify-center text-white">
                  ✓
                </span>
                Eligibility
              </h3>
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="w-6 h-6 rounded-full bg-primary/20 text-primary flex items-center justify-center shrink-0 mt-0.5">
                    •
                  </span>
                  <span>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="glass-card rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <a
                href="#register"
                className="btn-primary text-lg px-8 py-4 animate-pulse-glow mb-12 inline-flex"
              >
                Register Your Team
                <svg
                  xmlns="http://www.w3.org/2000/svg"
