...
const contactsOwnedRouteFiles = [
  ...
  '../users/[userId]/linked-promotions/route.ts',
...
describe('Contacts user-group API ownership', () => {
  ...
  it.each([
    ...
    ['[groupId]/indicators/route.ts', ['GET', 'POST', 'PATCH']],
    ['[groupId]/indicators/[indicatorId]/route.ts', ['PUT', 'DELETE']],
    ['[groupId]/indicators/categories/route.ts', ['POST']],
    ['[groupId]/indicators/categories/[categoryId]/route.ts', ['DELETE']],
