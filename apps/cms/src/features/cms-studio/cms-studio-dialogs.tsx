...
export function CmsCreateCollectionDialog({
  description,
  onConfirm,
  onDescriptionChange,
  onOpenChange,
      ...
      <DialogContent className="sm:max-w-lg">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="cms-new-collection-title">
              {strings.titleLabel}
            </Label>
            <Input
              id="cms-new-collection-title"
              value={title}
              onChange={(event) => onTitleChange(event.target.value)}
            />
          </div>
          <div className="space-y-2">
            <Label htmlFor="cms-new-collection-description">
              {strings.descriptionLabel}
            </Label>
            <Input
              id="cms-new-collection-description"
              value={description}
...
export function CmsDeleteEntryDialog({
  candidate,
  onConfirm,
  onOpenChange,
  open,
...
export function CmsDeleteCollectionDialog({
  candidate,
  onConfirm,
  onOpenChange,
  open,
