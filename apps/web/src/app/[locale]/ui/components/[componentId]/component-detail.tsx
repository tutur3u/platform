...
import { OnThisPage, type TocItem } from '../../docs-navigation';
import { PrevNextPager } from '../../docs-prev-next-pager';
import { CodeBlock, DocsPageHeader, DocsSection } from '../../docs-primitives';
import { componentDocsUrl } from '../../links';
      ...
      <article className="min-w-0">
        ...
        >
          <div className="flex flex-wrap items-center gap-2">
            ...
            <a
              className="inline-flex items-center gap-1.5 rounded-md border px-2.5 py-1 font-medium text-muted-foreground text-xs transition hover:bg-muted hover:text-foreground"
              href={componentDocsUrl(doc.slug)}
              rel="noreferrer"
              target="_blank"
            >
