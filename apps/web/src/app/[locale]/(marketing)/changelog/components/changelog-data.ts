...
/**
 * Figures for the hero rail.
 *
 * Everything here is counted off the rows actually on the page — no targets, no
 * "and growing". The version cell is omitted entirely when no entry carries
 * one, rather than printing a dash.
 */
