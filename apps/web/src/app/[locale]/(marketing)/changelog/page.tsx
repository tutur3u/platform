      ...
      <div className="relative mt-24">
        ...
        >
          <div className="relative flex flex-col items-start gap-6">
            <div className="from-foreground/5 via-foreground/10 to-foreground/5 bg-linear-to-b absolute left-[5px] top-0 h-full w-[2px]" />
            ...
            filteredUpdates.map((monthlyUpdate) => (
              ...
              >
                ...
                <div className="relative space-y-8">
                  <div className="from-foreground/5 via-foreground/10 to-foreground/5 bg-linear-to-b absolute left-8 top-0 hidden h-full w-[2px] lg:block" />
                    ...
                    >
                      ...
                      <Card className="group relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
                        <div className="absolute inset-0 overflow-hidden">
                          <div className="bg-linear-to-r absolute inset-0 opacity-100 transition-opacity duration-500 group-hover:opacity-100" />
                          <div
