    ...
    <div className="flex min-h-screen w-full flex-col items-center">
      <Suspense fallback={null}>
        {plan.id && (
          ...
          >
            <div className="flex w-full max-w-6xl flex-col items-center gap-6 p-4 text-foreground md:px-8 lg:gap-14 lg:px-14">
              <div className="flex w-full flex-col items-center">
                <UtilityButtons plan={plan} platformUser={platformUser} />
                <p className="my-4 flex max-w-xl items-center justify-center gap-2 text-center text-2xl leading-tight! font-semibold md:mb-4 lg:text-3xl">
