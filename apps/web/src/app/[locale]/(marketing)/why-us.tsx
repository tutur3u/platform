  ...
  return (
    <div className="flex h-screen w-full flex-col items-start justify-center">
      ...
      <div className="flex h-full w-full justify-center gap-8 px-14 text-center">
        <div className="flex h-2/3 w-2/5 flex-col">
          <div
          ...
          <div className="flex-auto bg-gray-700 p-4 text-white [clip-path:polygon(0_0,0_100%,76%_100%,76%_93%,83%_93%,95%_80%,100%_80%,100%_0)]">
        ...
        <div className="flex h-2/3 w-2/5 flex-col">
          ...
          <div className="relative flex-auto bg-gray-700 p-4 text-white">
            ...
            <div className="absolute -right-[48px] bottom-0 h-64 w-72 bg-gray-700 [clip-path:polygon(78%_60%,_78%_100%,_100%_100%,_100%_88%)]"></div>
          </div>
        </div>
        <div className="flex h-2/3 w-2/5 flex-col">
          <div
          ...
          <div className="flex-auto bg-gray-700 p-4 text-white [clip-path:polygon(0_0,_0_80%,_10%_90%,_10%_100%,_100%_100%,_100%_0)]">
            <div className="text-lg leading-relaxed">
              Events organized to support you find career paths in technology,
              gain deeper insights from company trips and alumni, and join
              coding competitions.
