                      ...
                      >
                        <div className="mb-4 flex items-center justify-between">
                          <div className="relative">
                            <div className="-inset-0.5 absolute rounded-full bg-linear-to-r from-primary to-dynamic-purple opacity-75 blur-sm group-hover:opacity-100" />
                            <Image
                            ...
                            />
                            {index < 3 && (
                              <div className="-top-1 -right-1 absolute flex h-6 w-6 items-center justify-center rounded-full bg-dynamic-amber font-bold text-[10px] text-white">
                                #{index + 1}
                              </div>
                            )}
                          </div>
