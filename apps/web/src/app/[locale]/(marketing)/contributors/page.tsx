    ...
    ),
  {
    loading: () => (
      <div className="grid gap-8 lg:grid-cols-2">
        <Card className="h-[388px] animate-pulse border-dynamic-purple/20 bg-dynamic-purple/5" />
        <Card className="h-[388px] animate-pulse border-dynamic-blue/20 bg-dynamic-blue/5" />
        <Card className="h-[388px] animate-pulse border-dynamic-green/20 bg-dynamic-green/5 lg:col-span-2" />
      </div>
    ),
    ssr: false,
  }
