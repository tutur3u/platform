              ...
              >
                <Card
                  className={cn(
                    ...
                    `border-dynamic-${guideline.color}/30 bg-gradient-to-br from-dynamic-${guideline.color}/5 via-background to-background hover:border-dynamic-${guideline.color}/50 hover:shadow-dynamic-${guideline.color}/10`
                  )}
                >
                  <div
                    className={cn(
