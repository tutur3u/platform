  ...
  return (
    <div className="relative flex w-full flex-col items-center px-8">
      <div className="z-20 m-8 h-screen w-full rounded-3xl bg-zinc-300/10 backdrop-blur-xl">
        {/* <div className="relative z-20 m-8 flex h-screen w-full items-center justify-center rounded-3xl bg-zinc-300/10 backdrop-blur-xl"> */}
        {/* <div className="absolute left-20 top-20 z-30 h-40 w-60 rounded-lg bg-gray-600/30"></div> */}
