  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="bg-linear-to-b from-background via-background to-dynamic-light-pink/10 relative min-h-[calc(100vh-3.5rem+53px)] w-full"
      >
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col items-center justify-center px-4 py-32">
          ...
          >
            <div className="bg-linear-to-r from-primary/20 via-primary/10 to-primary/20 absolute -inset-x-4 -inset-y-2 rounded-xl opacity-0 blur-xl transition-all duration-300 group-hover:opacity-100" />
            <h1 className="text-foreground relative mx-auto mb-4 text-center text-2xl font-bold tracking-tight md:text-4xl lg:text-6xl">
              <span className="bg-linear-to-r from-primary/20 to-primary/10 absolute -inset-1 rounded-lg opacity-0 blur transition-all duration-300 group-hover:opacity-100" />
            ...
            >
              <Card className="relative h-full overflow-hidden">
                <div className="bg-primary/5 group-hover:bg-primary/10 relative flex h-full flex-col p-8 transition-all duration-300">
                  <div className="bg-linear-to-br from-primary/10 absolute inset-0 via-transparent to-transparent opacity-0 transition-all duration-300 group-hover:opacity-100" />
                  ...
                  <div className="bg-linear-to-r from-primary/20 to-primary/5 absolute bottom-0 left-0 right-0 h-1 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                </div>
              </Card>
            </motion.div>
                    ...
                    <div className="relative">
                      <div className="relative mb-6">
                        <div className="bg-foreground text-background relative flex h-16 w-16 items-center justify-center rounded-full">
                          ...
                          <div className="bg-linear-to-br from-primary/20 to-primary/5 absolute inset-0 rounded-full opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
              ...
              >
                <Card className="h-full overflow-hidden">
                  <div className="bg-primary/5 group-hover:bg-primary/10 flex h-full flex-col p-6 transition-all duration-300">
                    ...
                    <blockquote className="mb-4 grow text-lg italic">
                      "{testimonial.quote}"
                    </blockquote>
                    <div>
          ...
          >
            <div className="text-center">
              ...
              <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
                ...
                >
                  <div className="bg-linear-to-r from-primary/20 to-primary/0 absolute inset-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                ...
                >
                  <div className="bg-linear-to-r from-primary/10 to-primary/5 absolute inset-0 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                  <span className="relative flex items-center justify-center gap-2 font-medium">
