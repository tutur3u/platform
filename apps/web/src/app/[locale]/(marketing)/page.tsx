                  ...
                  <div className="relative">
                    <div className="text-primary mb-4 flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <div className="bg-background/50 border-primary/10 flex h-12 w-12 items-center justify-center rounded-full border backdrop-blur-sm">
                          {product.icon}
                        </div>
                    ...
                    <div className="space-y-4">
                      <div className="flex flex-wrap gap-4">
                        {product.features.map((feature, index) => (
                          <div
                            key={index}
                            className="bg-background/50 border-primary/10 flex items-center gap-2 rounded-full border px-3 py-1 backdrop-blur-sm"
                          >
      ...
      >
        ...
        <div className="grid gap-8 md:grid-cols-2">
          ...
          >
            <Card className="bg-primary/5 relative h-full overflow-hidden p-8">
              <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(var(--primary-rgb),0.05)_1px,transparent_1px)] bg-[size:10px_10px] opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
              <div className="relative">
                <div className="bg-background/50 border-primary/10 mb-6 inline-flex rounded-full border p-3 backdrop-blur-sm">
                  <Building2 className="text-primary h-8 w-8" />
                </div>
                ...
                <div className="space-y-4">
                  {businessBenefits.map((benefit: string) => (
                    <div key={benefit} className="flex items-start gap-3">
                      <div className="bg-background/50 border-primary/10 flex h-6 w-6 flex-none items-center justify-center rounded-full border backdrop-blur-sm">
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          <motion.div
            ...
            className="group"
          >
            <Card className="bg-background/50 border-primary/10 relative overflow-hidden p-6 backdrop-blur-sm">
      ...
      >
        ...
        <div className="relative mx-auto px-4">
          <motion.div
            ...
            viewport={{ once: true }}
            className="bg-background/50 border-primary/10 rounded-2xl border p-8 shadow-xl backdrop-blur-md"
          >
