  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="relative min-h-[calc(100vh-3.5rem+53px)] w-full bg-linear-to-b from-background via-background to-dynamic-light-pink/10"
      >
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col items-center justify-center px-4 py-32">
          ...
          >
            <div className="absolute -inset-x-4 -inset-y-2 rounded-xl bg-linear-to-r from-primary/20 via-primary/10 to-primary/20 opacity-0 blur-xl transition-all duration-300 group-hover:opacity-100" />
            <h1 className="relative mx-auto mb-4 text-center text-2xl font-bold tracking-tight text-foreground md:text-4xl lg:text-6xl">
              <span className="absolute -inset-1 rounded-lg bg-linear-to-r from-primary/20 to-primary/10 opacity-0 blur transition-all duration-300 group-hover:opacity-100" />
            ...
            >
              <Card className="relative h-full overflow-hidden">
                <div className="relative flex h-full flex-col bg-primary/5 p-8 transition-all duration-300 group-hover:bg-primary/10">
                  <div className="absolute inset-0 bg-linear-to-br from-primary/10 via-transparent to-transparent opacity-0 transition-all duration-300 group-hover:opacity-100" />
                  ...
                  <div className="absolute right-0 bottom-0 left-0 h-1 bg-linear-to-r from-primary/20 to-primary/5 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
                </div>
              </Card>
            </motion.div>
                    ...
                    <div className="relative">
                      <div className="relative mb-6">
                        <div className="relative flex h-16 w-16 items-center justify-center rounded-full bg-foreground text-background">
                          ...
                          <div className="absolute inset-0 rounded-full bg-linear-to-br from-primary/20 to-primary/5 opacity-0 transition-opacity duration-300 group-hover:opacity-100" />
