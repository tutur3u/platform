              ...
              <div className="p-6">
                <div className="mb-6">
                  ...
                  <div className="h-5 w-full overflow-hidden rounded-full bg-foreground/10">
                    <div className="progress-bar-1 h-full w-0 rounded-full bg-gradient-to-r from-dynamic-green to-dynamic-green/70"></div>
                  </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="h-5 w-full overflow-hidden rounded-full bg-foreground/10">
                    <div className="progress-bar-2 h-full w-0 rounded-full bg-gradient-to-r from-dynamic-blue to-dynamic-light-blue"></div>
                  </div>
                  <div className="mt-2 flex justify-between text-sm">
