...
export function FaqSection() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute -top-40 left-0 h-96 w-96 rounded-full bg-dynamic-light-purple/10 blur-3xl filter"></div>
      <div className="absolute right-0 -bottom-40 h-96 w-96 rounded-full bg-dynamic-light-blue/10 blur-3xl filter"></div>
        ...
        <div className="mx-auto max-w-4xl">
          ...
          <div className="faq-search mb-10 flex items-center justify-center">
            <div className="relative w-full max-w-lg">
              ...
              <input
                ...
                className="w-full rounded-full border border-input bg-white/90 py-3 pr-10 pl-10 text-sm ring-offset-background transition-all duration-300 placeholder:text-muted-foreground focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 focus:outline-none dark:bg-foreground/5"
                aria-label="Search questions"
              />
              {searchQuery && (
                <button
                  onClick={handleClearSearch}
                  className="absolute top-1/2 right-3 -translate-y-1/2 rounded-full p-1 text-muted-foreground hover:bg-gray-100 hover:text-foreground dark:hover:bg-gray-800"
          ...
          <div className="faq-accordion">
            ...
            {filteredFaqs.length > 0 ? (
              ...
              >
                {filteredFaqs.map((faq, index) => (
                  <AccordionItem
                    key={index}
                    value={`item-${index}`}
                    className="faq-item rounded-xl border border-input bg-white/90 shadow-sm transition-all duration-300 hover:shadow-md dark:bg-foreground/5"
                  >
                    <AccordionTrigger
                    ...
                    <AccordionContent className="px-6 pt-0 pb-6 text-balance text-muted-foreground">
              ...
              <div className="flex flex-col items-center justify-center rounded-xl border border-input bg-white/90 p-12 text-center dark:bg-foreground/5">
          ...
          <div className="mt-16 flex flex-col items-center justify-center rounded-xl border border-input bg-white/90 p-8 text-center shadow-sm dark:bg-foreground/5">
