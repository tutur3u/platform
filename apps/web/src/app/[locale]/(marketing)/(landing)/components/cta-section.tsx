  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden opacity-20">
        ...
        <div className="-translate-x-1/2 -translate-y-1/2 absolute top-1/2 left-1/2 h-60 w-60 transform rounded-full bg-white blur-3xl"></div>
      </div>
      ...
      <div className="relative z-10 px-6 py-20 md:px-20 md:py-24">
        <div className="cta-content mx-auto max-w-4xl text-center">
          <h2 className="mb-6 text-balance font-bold text-4xl text-white leading-normal md:text-5xl lg:text-6xl">
            {t('ready_to_transform_your_calendar_experience')}
          </h2>
          <p className="mb-10 text-balance text-white/90 text-xl leading-relaxed md:text-2xl">
            {t(
          ...
          <div className="flex flex-col justify-center gap-5 sm:flex-row">
            <Link href="/onboarding">
              <Button
                size="lg"
                className="cta-button relative overflow-hidden bg-white px-8 font-medium text-lg text-purple-600 transition-all duration-300 hover:bg-gray-100 hover:shadow-lg hover:shadow-purple-700/20"
              >
                <span className="relative z-10">{t('get_early_access')}</span>
                <span className="-z-0 absolute inset-0 bg-[length:200%_100%] bg-gradient-to-r from-white via-purple-100 to-white opacity-0 transition-opacity duration-300 hover:animate-shimmer hover:opacity-100"></span>
              </Button>
            </Link>
          </div>
          <div className="mt-8 rounded-xl bg-white/10 p-4 backdrop-blur-sm">
            <p className="text-balance font-medium text-lg text-white">
              {t(
