    ...
    >
      ...
      <div className="relative z-10 px-6 py-20 md:px-20 md:py-24">
        <div className="cta-content mx-auto max-w-4xl text-center">
          <h2 className="mb-6 text-balance text-4xl font-bold leading-normal text-white md:text-5xl lg:text-6xl">
            {t('ready_to_transform_your_calendar_experience')}
          </h2>
          <p className="mb-10 text-balance text-xl leading-relaxed text-white/90 md:text-2xl">
            {t(
