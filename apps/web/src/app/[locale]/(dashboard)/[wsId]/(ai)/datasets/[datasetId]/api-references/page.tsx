...
export default async function ApiReferencesPage({ params }: Props) {
  ...
  const apiKeys = await getApiKeys(wsId);
    ...
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Set up your environment variables and API key to authenticate your
            requests.
          </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            <TabsContent value="python" className="m-0 space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Use python-dotenv to load the environment variables from
                    your .env file.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <CodeBlock language="python" value={pythonDataframeCode} />
                </CardContent>
              </Card>
            </TabsContent>
            ...
            <TabsContent value="javascript" className="m-0 space-y-6">
              <Card>
                <CardHeader>
                  <CardTitle>Fetch Data</CardTitle>
                  <CardDescription>
                    Use the Fetch API to make a request to our endpoint with
                    your API key.
                  </CardDescription>
                </CardHeader>
                <CardContent>
              ...
              <Card>
                ...
                <CardContent>
                  <CodeBlock language="javascript" value={jsProcessCode} />
                </CardContent>
              </Card>
            </TabsContent>
          </div>
