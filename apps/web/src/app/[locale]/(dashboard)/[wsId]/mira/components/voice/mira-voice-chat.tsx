...
import { useMiraToken } from '../../hooks/use-mira-token';
import type { MiraAnimationState } from '../../types/mira';

interface MiraVoiceChatProps {
  wsId: string;
  onAnimationChange?: (state: MiraAnimationState) => void;
...
function VoiceStatus({
  ...
  const getStatus = () => {
    ...
    if (isSpeaking) return t('status.mira_speaking');
...
function VoiceControl({
  ...
  // Update Mira's animation based on voice state
  useEffect(() => {
