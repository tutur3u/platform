...
export const PRESET_SCENARIOS: CalendarScenario[] = [
  ...
  },
  {
    ...
    description:
      '20+ tasks, many critical, meeting-heavy days. Stress test for gap filling.',
    ...
    events: [
      {
        id: 'locked-1',
        title: 'Investor Pitch (LOCKED)',
        start_at: '2024-01-01T13:00:00Z',
      ...
      {
        id: 'locked-2',
        title: 'Flight to Singapore (LOCKED)',
  ...
  },
  {
    ...
    description:
      'Multiple daily habits with strict ideal times and high priority.',
    tasks: [
      {
        id: 'sm-t1',
        name: 'Light Work',
  ...
  },
  {
    ...
    name: 'The Night Owl',
    description:
      'Work and personal hours shifted to late night. Testing timezone and boundary handling.',
    tasks: [
      {
        id: 'no-t1',
    ...
    settings: {
      hours: {
        ...
        workHours: {
          monday: {
            enabled: true,
            timeBlocks: [{ startTime: '14:00', endTime: '22:00' }],
          },
          tuesday: {
            enabled: true,
            timeBlocks: [{ startTime: '14:00', endTime: '22:00' }],
        ...
        personalHours: {
          monday: {
            enabled: true,
            timeBlocks: [{ startTime: '22:00', endTime: '03:00' }],
          },
          tuesday: {
            enabled: true,
            timeBlocks: [{ startTime: '22:00', endTime: '03:00' }],
          ...
          saturday: {
            enabled: true,
            timeBlocks: [{ startTime: '12:00', endTime: '03:00' }],
          },
          sunday: {
            enabled: true,
            timeBlocks: [{ startTime: '12:00', endTime: '03:00' }],
  ...
  },
  {
    ...
    description:
      'High load on weekends, minimal on weekdays. Testing weekend hour handling.',
  ...
  },
  {
    ...
    description:
      'Many short tasks (30m) that should fill every available gap. Testing granularity.',
  ...
  },
  {
    ...
    description:
      'Many overlapping locked events to test how the algorithm navigates tight constraints.',
