...
import { AbuseIntelligenceClient } from './abuse-intelligence-client';
...
export default async function InfrastructureAbuseIntelligencePage({
  params,
}: Props) {
  ...
  const t = await getTranslations('abuse-intelligence');
