...
const TimezoneCard = ({ data }: Props) => {
  return (
    <div className="border-border group flex cursor-pointer flex-col items-center justify-center rounded-lg border bg-zinc-500/5 text-center transition hover:bg-zinc-500/10 dark:border-zinc-700/80 dark:bg-zinc-800/70 dark:hover:bg-zinc-800">
