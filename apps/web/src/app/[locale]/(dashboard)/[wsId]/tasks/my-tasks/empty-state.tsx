...
export default function EmptyState({ wsId, onSwitchToJournal }: EmptyStateProps) {
  ...
  return (
    <Card className="border-2 border-dashed border-dynamic-muted/50">
        ...
        <div className="mx-auto max-w-2xl space-y-4">
          <div className="grid gap-3 sm:grid-cols-2">
            <Link href={`/${wsId}/tasks/boards`} className="w-full">
              <Button className="h-[88px] w-full flex-col gap-2 py-4 sm:flex-row">
