  ...
  return (
    <div className="animate-pulse rounded-lg border p-4 opacity-50">
      <div className="mb-2 flex w-full items-center border-b pb-2">
        <div className="bg-linear-to-br aspect-square h-10 w-10 rounded-lg from-green-300 via-blue-500 to-purple-600 dark:from-green-300/70 dark:via-blue-500/70 dark:to-purple-600/70" />
