...
export default function ScheduleCalendar({
    ...
    const [sessions, setSessions] = useState<Set<string>>(new Set(initialSessions));
    ...
    const handleDayHeaderClick = useCallback((dayIndex: number, monthDate: Date) => {
        ...
        const dateStrings = datesInColumn.map(d => dayjs(d).format('YYYY-MM-DD'));
