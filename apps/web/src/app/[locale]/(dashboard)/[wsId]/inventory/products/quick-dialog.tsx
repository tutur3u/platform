                        ...
                        <CardContent className="flex flex-col gap-2 p-4">
                          ...
                          <div className="flex flex-col gap-1">
                            <div className="flex items-center gap-2">
                              ...
                              <p className="min-w-0 flex-1 wrap-break-word font-medium text-sm text-white text-balance">
                          ...
                          {change.beneficiary && (
                            <div className="flex items-center gap-2 rounded bg-slate-800/50 p-2">
                              ...
                              <span className="min-w-0 flex-1 wrap-break-word text-blue-400 text-sm text-balance">
