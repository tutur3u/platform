...
export function RequestsClient({
  ...
  const { data: requestsData, isLoading, isError, error } = useRequests({
    wsId,
  ...
  const { data: availableUsersData = [], isLoading: usersLoading } = useAvailableUsers({
    wsId,
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {request.approval_status === 'PENDING' && t('status.pending')}
