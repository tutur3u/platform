...
import { getWorkspaceFlashcardColumns } from '../../flashcards/columns';
import FlashcardForm from '../../flashcards/form';

export const metadata: Metadata = {
  title: 'Library Flashcards',
  description: 'Manage shared flashcards in your workspace education library.',
};
...
export default async function WorkspaceLibraryFlashcardsPage({
  params,
  searchParams,
}: Props) {
      ...
      <EducationPageHeader
        ...
        secondaryAction={
          <Button asChild variant="outline" className="rounded-xl">
            <Link href={`/${routeWsId}/education/library/quiz-sets`}>
        ...
        primaryAction={
          <ModifiableDialogTrigger
            ...
            form={<FlashcardForm wsId={resolvedWsId} />}
            trigger={
