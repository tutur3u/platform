...
const initialPositions: Record<string, { type: PieceType, positions: number[] }> = {
...
export { horizontal, vertical, pieces, initialPositions, PieceType, TeamType, removePieceById };
export type { Piece };