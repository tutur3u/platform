...
export default function WorkspaceUserSettingsPage() {
    ...
    <div className="flex min-h-full w-full flex-col ">
      {user && hasRequiredFields() && (
        <div
          ...
          } border-foreground/10 bottom-0 z-[100] mb-[4.5rem] flex flex-col items-center justify-between gap-y-4 rounded-lg border bg-zinc-500/5 p-4 backdrop-blur transition-all duration-500 dark:border-zinc-300/10 dark:bg-zinc-900/80 md:mb-4 md:flex-row ${
      ...
      <div className="grid gap-x-8 gap-y-4 pb-32 xl:grid-cols-2 xl:gap-x-16">
