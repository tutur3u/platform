    ...
    <div className="mx-4 flex flex-col gap-8 pt-24 md:mx-32 lg:mx-64">
      ...
      <section>
        ...
        <div className="grid grid-cols-2 gap-4 font-bold md:text-lg lg:grid-cols-3 xl:grid-cols-4 xl:text-xl">
          <div className="flex h-32 items-center justify-center rounded-lg bg-[#4180E9] md:h-48">
            #4180E9
          </div>
          <div className="flex h-32 items-center justify-center rounded-lg bg-[#4ACA3F] md:h-48">
            #4ACA3F
          </div>
          <div className="flex h-32 items-center justify-center rounded-lg bg-[#FB7B05] md:h-48">
            #FB7B05
          </div>
          <div className="flex h-32 items-center justify-center rounded-lg bg-[#E94646] md:h-48">
            #E94646
          </div>
          <div className="flex h-32 items-center justify-center rounded-lg bg-[#26292F] md:h-48">
            #26292F
          </div>
          <div className="flex h-32 items-center justify-center rounded-lg bg-[#FFFFFF] text-[#363636] md:h-48">
            #FFFFFF
          </div>
          <div className="col-span-full flex h-32 items-center justify-center rounded-lg bg-[#363636] md:h-48 xl:col-span-2">
            #363636
          </div>
        </div>
      </section>
