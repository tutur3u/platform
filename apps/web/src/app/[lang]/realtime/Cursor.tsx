    ...
    <>
      {!_isLocalClient && (
        <svg
          ...
          viewBox="0 0 18 24"
          fill="none"
          className="pointer-events-none absolute left-0 top-0 transform transition"
      ...
      <div
        ref={chatBubbleRef}
        className={[
          'absolute left-0 top-0 rounded-full py-2 shadow-md transition-all',
          'pointer-events-none flex items-center justify-between space-x-2 px-4',
        ...
        style={{
          ...
          transform: `translateX(${
            ...
            (y || 0) + (flipY ? -chatBubbleRef.current.clientHeight - 20 : 20)
          }px)`,
        }}
      >
        {_isLocalClient && !hideInput ? (
          ...
          <div className="flex items-center justify-center">
            <div className="loader-dots relative block h-6 w-10">
              <div className="absolute top-0 my-2.5 h-1.5 w-1.5 rounded-full bg-white opacity-75"></div>
              <div className="absolute top-0 my-2.5 h-1.5 w-1.5 rounded-full bg-white opacity-75"></div>
              <div className="absolute top-0 my-2.5 h-1.5 w-1.5 rounded-full bg-white opacity-75"></div>
              <div className="absolute top-0 my-2.5 h-1.5 w-1.5 rounded-full bg-white opacity-75"></div>
            </div>
