...
import { emailRouteLoaders } from '@/legacy-api-routes/registry/email';

const dispatch = createLegacyApiDispatcher(emailRouteLoaders, {
  requestPrefixSegments: ['email'],
  routeFilePrefixSegments: ['email'],
});
