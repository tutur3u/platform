...
const systemInstruction = `
  ...
  - ALWAYS Escape the Dollar Sign with "\\$" in casual context like ($1,000 worth of games) to avoid LaTeX-related rendering issues. e.g. \\$1.00 will be rendered as $1.00.
