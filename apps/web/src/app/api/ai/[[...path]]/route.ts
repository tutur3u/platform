...
import { aiRouteLoaders } from '@/legacy-api-routes/registry/ai';

const dispatch = createLegacyApiDispatcher(aiRouteLoaders, {
  requestPrefixSegments: ['ai'],
  routeFilePrefixSegments: ['ai'],
});
