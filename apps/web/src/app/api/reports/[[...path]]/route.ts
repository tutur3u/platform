...
import { reportsRouteLoaders } from '@/legacy-api-routes/registry/reports';

const dispatch = createLegacyApiDispatcher(reportsRouteLoaders, {
  requestPrefixSegments: ['reports'],
  routeFilePrefixSegments: ['reports'],
});
