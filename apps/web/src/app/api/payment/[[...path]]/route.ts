...
import { paymentRouteLoaders } from '@/legacy-api-routes/registry/payment';

const dispatch = createLegacyApiDispatcher(paymentRouteLoaders, {
  requestPrefixSegments: ['payment'],
  routeFilePrefixSegments: ['payment'],
});
