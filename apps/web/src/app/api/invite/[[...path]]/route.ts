...
import { inviteRouteLoaders } from '@/legacy-api-routes/registry/invite';

const dispatch = createLegacyApiDispatcher(inviteRouteLoaders, {
  requestPrefixSegments: ['invite'],
  routeFilePrefixSegments: ['invite'],
});
