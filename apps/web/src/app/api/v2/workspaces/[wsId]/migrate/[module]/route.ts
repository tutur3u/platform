...
const MODULE_TABLE_MAP: Record<string, string> = {
  ...
  'user-coupons': 'workspace_user_linked_promotions',
  'lessons': 'user_group_posts',
  'score-names': 'workspace_user_indicators',
  'grouped-score-names': 'user_group_indicators',
  'class-scores': 'user_group_indicator_values',
  'class-members': 'user_group_members',
  'user-group-users': 'user_group_members', // Alias for class-members
  'class-packages': 'user_group_linked_products',
  'class-attendance': 'user_group_attendance',
  'student-feedbacks': 'workspace_user_feedbacks',
  'package-stock-changes': 'inventory_product_stock_changes',
  'user-monthly-reports': 'workspace_user_monthly_reports',
  'user-monthly-report-logs': 'workspace_user_monthly_report_logs',
...
const WORKSPACE_COLUMN_MAP: Record<string, string> = {
  ...
  'workspace_user_linked_promotions': 'ws_id',
  'user_group_posts': 'ws_id',
  'workspace_user_indicators': 'ws_id',
  'user_group_indicators': 'ws_id',
  'user_group_indicator_values': 'ws_id',
  'user_group_members': 'ws_id',
  'user_group_linked_products': 'ws_id',
  'user_group_attendance': 'ws_id',
  'workspace_user_feedbacks': 'ws_id',
  'inventory_product_stock_changes': 'ws_id',
  'workspace_user_monthly_reports': 'ws_id',
  'workspace_user_monthly_report_logs': 'ws_id',
