...
import { usersRouteLoaders } from '@/legacy-api-routes/registry/users';

const dispatch = createLegacyApiDispatcher(usersRouteLoaders, {
  requestPrefixSegments: ['users'],
  routeFilePrefixSegments: ['users'],
});
