...
import { billingRouteLoaders } from '@/legacy-api-routes/registry/billing';

const dispatch = createLegacyApiDispatcher(billingRouteLoaders, {
  requestPrefixSegments: ['billing'],
  routeFilePrefixSegments: ['billing'],
});
