...
describe('external project team access routes', () => {
  ...
  it('loads team context through external project access', async () => {
    const { GET } = await import(
      '@/app/api/v1/workspaces/[wsId]/external-projects/members/route'
    );
  ...
  it('loads people, access levels, and defaults without workspace settings routes', async () => {
    const [{ GET: getMembers }, { GET: getRoles }, { GET: getDefaults }] =
      await Promise.all([
        import(
          '@/app/api/v1/workspaces/[wsId]/external-projects/members/enhanced/route'
        ),
        import(
          '@/app/api/v1/workspaces/[wsId]/external-projects/members/roles/route'
        ),
        import(
          '@/app/api/v1/workspaces/[wsId]/external-projects/members/roles/default/route'
        ),
      ]);
