...
describe('external app workspace member routes', () => {
  ...
  it('loads members with read scopes', async () => {
    const { GET } = await import(
      '@/app/api/v1/workspaces/[wsId]/external-apps/members/route'
    );
  ...
  it('invites members with member-write access', async () => {
    const { POST } = await import(
      '@/app/api/v1/workspaces/[wsId]/external-apps/members/invitations/route'
    );
  ...
  it('removes access with member-write access', async () => {
    const { DELETE } = await import(
      '@/app/api/v1/workspaces/[wsId]/external-apps/members/access/route'
    );
  ...
  it('updates roles with member-write and role-write access', async () => {
    const { PATCH } = await import(
      '@/app/api/v1/workspaces/[wsId]/external-apps/members/[userId]/role/route'
    );
  ...
  it('updates default admin with member-write and role-write access', async () => {
    const { PATCH } = await import(
      '@/app/api/v1/workspaces/[wsId]/external-apps/members/default-admin/route'
    );
