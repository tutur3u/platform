/**
 * Mira Focus History API
 * GET /api/v1/mira/focus/history - Get detailed focus session history
 */
...
export async function GET(request: Request) {
  try {
    ...
    console.error('Unexpected error in GET /api/v1/mira/focus/history:', error);
    return NextResponse.json(
