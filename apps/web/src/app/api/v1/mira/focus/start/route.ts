/**
 * Mira Focus Session Start API
 * POST /api/v1/mira/focus/start - Start a new focus session
 */
...
export async function POST(request: Request) {
  try {
    ...
    console.error('Unexpected error in POST /api/v1/mira/focus/start:', error);
    return NextResponse.json(
