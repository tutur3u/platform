...
import { workspacesRouteLoaders } from '@/legacy-api-routes/registry/workspaces';

const dispatch = createLegacyApiDispatcher(workspacesRouteLoaders, {
  requestPrefixSegments: ['workspaces'],
  routeFilePrefixSegments: ['workspaces'],
});
