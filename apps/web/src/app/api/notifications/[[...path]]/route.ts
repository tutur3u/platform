...
import { notificationsRouteLoaders } from '@/legacy-api-routes/registry/notifications';

const dispatch = createLegacyApiDispatcher(notificationsRouteLoaders, {
  requestPrefixSegments: ['notifications'],
  routeFilePrefixSegments: ['notifications'],
});
