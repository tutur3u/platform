...
const SupplierEditModal = ({ wsId, oldSupplier, supplier }: Props) => {
  ...
  useEffect(() => {
    ...
    mutate(`/api/workspaces/${wsId}/inventory/suppliers/${supplier.id}`);
  ...
  }, [hasSuccess, wsId, supplier.id]);

  const updateDetails = async () => {
    // If the supplier is not changed, skip this step
    ...
    const res = await fetch(
      `/api/workspaces/${wsId}/inventory/suppliers/${id}`,
      {
        method: 'PUT',
        headers: {
