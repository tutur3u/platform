  ...
  return (
    <>
      <div className="absolute inset-0 mx-4 my-32 flex items-start justify-center md:mx-4 md:items-center lg:mx-32">
        <div className="flex w-full max-w-xl flex-col items-center gap-4 rounded-xl bg-zinc-700/50 p-4 text-zinc-300 backdrop-blur-2xl md:p-8">
          <Text size="lg" mt="md" color="muted" align="center">
            {emailSentP1} <span className="font-semibold text-zinc-200">{email}</span>.{' '}
            {emailSentP2}
          </Text>
