    ...
    >
      ...
      <div className="grid h-full w-full gap-2 p-2">
        ...
        {showLimits && maxPerMonth && (
          <div className="line-clamp-1 flex h-full items-center justify-center gap-1 rounded border border-blue-300/20 bg-blue-300/10 p-2 font-semibold text-blue-300">
            <span className="opacity-75">Tối đa</span>{' '}
            {Intl.NumberFormat('vi-VN', {
              style: 'currency',
              currency: 'VND',
