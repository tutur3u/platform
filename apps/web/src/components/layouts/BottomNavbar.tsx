...
export default function BottomNavbar() {
  ...
  return (
    <div className="border-foreground/10 fixed bottom-0 z-[100] flex w-full items-center justify-between gap-2 border-t bg-white/50 p-2 backdrop-blur dark:border-zinc-800 dark:bg-[#111113]/50 md:hidden">
      <SidebarLink
