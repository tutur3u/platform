...
const MiniPlusButton = ({ href, onClick, className }: Props) => {
  if (href)
    return (
      <Link
        href={href}
        className={`group flex items-center justify-center rounded-lg border border-border bg-zinc-500/5 p-1 transition hover:bg-zinc-500/10 dark:border-zinc-700/80 dark:bg-zinc-800/70 dark:hover:bg-zinc-800 ${className}`}
      >
