...
const PlusCardButton = ({ href, onClick }: Props) => {
  if (href)
    return (
      <Link
        href={href}
        className="group flex items-center justify-center rounded-lg border border-border bg-zinc-500/10 p-4 transition hover:bg-zinc-500/20 dark:border-zinc-700/80 dark:bg-zinc-800/70 dark:hover:bg-zinc-800"
      >
