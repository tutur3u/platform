...
const CalendarViewWithTrail = () => {
  ...
  return (
    <div
      id="calendar-view"
      className="scrollbar-none border-foreground/10 flex h-full overflow-x-hidden overflow-y-scroll scroll-smooth rounded-b-lg border-b border-l text-center dark:border-zinc-800"
    >
      <TimeTrail />
      <CalendarView />
    </div>
