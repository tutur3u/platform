    ...
    <Card className="overflow-hidden">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        ...
        <CardContent className="p-4">
          ...
          >
            <div className="space-y-4">
              <div className="space-y-2">
                <h3 className="font-medium text-sm">Race Results</h3>
                <div className="flex flex-wrap items-center gap-1 rounded-md bg-muted/30 p-3">
                  {currentRace.result.map((id, index) => (
                    <motion.div
                      key={id}
                      className="fade-in slide-in-from-bottom-2 flex animate-in items-center duration-300"
                      style={{ animationDelay: `${index * 100}ms` }}
                    >
                      <div
                        className="group relative flex h-12 w-12 items-center justify-center rounded-full font-bold text-sm text-white shadow-sm transition-transform hover:scale-110"
                        style={{
              ...
              <div className="space-y-2">
                <h3 className="font-medium text-sm">Participating Horses</h3>
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5">
                  {currentRace.horses.map((id) => {
                    ...
                    return (
                      ...
                      >
                        <div
                          className="mr-3 flex h-8 w-8 items-center justify-center rounded-full font-bold text-white text-xs"
                          style={{
              ...
              <div className="flex items-center justify-between">
                <div className="h-2 flex-1 rounded-full bg-linear-to-r from-green-400 to-red-400 shadow-inner"></div>
                <div className="ml-2 flex items-center gap-1 font-medium text-muted-foreground text-xs">
          ...
          >
            <div className="space-y-4">
              <h3 className="font-medium text-sm">Horse Racing History</h3>
          ...
          >
            <div className="space-y-4">
              <h3 className="font-medium text-sm">Race Statistics</h3>
              ...
              <div className="grid gap-4 sm:grid-cols-2">
                ...
                <div className="rounded-md border p-3">
                  <h4 className="mb-2 font-medium text-xs">Race Info</h4>
