...
alter table "public"."workspace_user_fields" enable row level security;
...
alter table "public"."field_types" add constraint "field_types_pkey" PRIMARY KEY using index "field_types_pkey";

alter table "public"."workspace_user_fields" add constraint "workspace_user_fields_pkey" PRIMARY KEY using index "workspace_user_fields_pkey";

alter table "public"."workspace_user_fields" add constraint "public_workspace_user_fields_type_fkey" FOREIGN KEY (type) REFERENCES field_types(id) not valid;

alter table "public"."workspace_user_fields" validate constraint "public_workspace_user_fields_type_fkey";

alter table "public"."workspace_user_fields" add constraint "public_workspace_user_fields_ws_id_fkey" FOREIGN KEY (ws_id) REFERENCES workspaces(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "public"."workspace_user_fields" validate constraint "public_workspace_user_fields_ws_id_fkey";
...
grant update on table "public"."workspace_user_fields" to "authenticated";

grant delete on table "public"."workspace_user_fields" to "service_role";

grant insert on table "public"."workspace_user_fields" to "service_role";

grant references on table "public"."workspace_user_fields" to "service_role";

grant select on table "public"."workspace_user_fields" to "service_role";
...
grant update on table "public"."workspace_user_fields" to "service_role";

create policy "Allow all access for workspace members"
on "public"."workspace_user_fields"
as permissive
for all
to authenticated
