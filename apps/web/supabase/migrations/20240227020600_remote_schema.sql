...
alter table "public"."finance_invoice_products" alter column "unit_id" set not null;

alter table "public"."finance_invoice_products" alter column "warehouse_id" set not null;

alter table "public"."finance_invoices" add constraint "public_finance_invoices_creator_id_fkey" FOREIGN KEY (creator_id) REFERENCES workspace_users(id) ON UPDATE CASCADE ON DELETE SET DEFAULT not valid;

alter table "public"."finance_invoices" validate constraint "public_finance_invoices_creator_id_fkey";
