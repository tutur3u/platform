 ...
 * stored in minor units — e.g. decimal Inventory product prices, Finance
 * invoice totals, summary revenue, and promotion values. For processor and
 * storefront amounts stored in minor units, use {@link money} instead.
 *
 ...
 * processor/storefront money — checkout totals and storefront line subtotals
