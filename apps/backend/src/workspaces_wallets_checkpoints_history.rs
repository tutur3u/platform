...
const PATH_SUFFIX: &str = "/wallets/checkpoints/history";
...
const ERROR_FETCHING_HISTORY: &str = "Error fetching wallet checkpoint history";
...
async fn list_wallet_audit_statuses(
    contact_data: &contact::ContactDataConfig,
    outbound: &impl OutboundHttpClient,
    wallet_ids: &[String],
...
fn sanitize_audit_statuses_by_window(
...
fn wallets_only_payload(wallets: &[SummaryWallet]) -> Value {
    json!({
        "audit_statuses": [],
        "checkpoints": [],
        "intervals": [],
