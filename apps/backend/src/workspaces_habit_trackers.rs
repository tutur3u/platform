...
const PATH_SUFFIX: &str = "/habit-trackers";

const SIGN_IN_MESSAGE: &str = "Please sign in to use habit trackers";
...
fn parse_query(request_url: Option<&str>) -> Result<ListQuery, ()> {
