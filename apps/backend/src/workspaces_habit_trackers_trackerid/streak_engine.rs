...
pub(super) struct EffectiveMetric {
    ...
    pub(super) used_freeze: bool,
    pub(super) used_repair: bool,
    pub(super) entry_count: f64,
    pub(super) is_current_period: bool,
}
...
pub(super) fn metric_json(metric: &EffectiveMetric) -> Value {
    json!({
