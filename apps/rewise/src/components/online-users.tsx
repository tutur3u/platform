              ...
              <Tooltip key={userId}>
                <TooltipTrigger asChild>
                  <div className="relative inline-block transition-transform hover:z-10 hover:scale-110">
                    ...
                    {instances.length > 1 && (
                      <span className="absolute -top-0.5 -right-0.5 flex h-4 w-4 items-center justify-center rounded-full bg-blue-500 font-medium text-[10px] text-white ring-2 ring-white">
                        {instances.length}
                      </span>
                    )}
                  </div>
