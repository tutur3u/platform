...
/**
 * Server action to send OTP to user's email (Rewise app)
...
export async function sendOtpAction(
  ...
  try {
    ...
    console.error('SendOTP Server Action Error (Rewise):', error);
    return {
...
/**
 * Server action to verify OTP code (Rewise app)
 */
export async function verifyOtpAction(
  ...
  try {
    ...
    console.error('VerifyOTP Server Action Error (Rewise):', error);
    return {
