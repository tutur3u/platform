...
export const recommendedTools = [
  ...
  },
  {
    ...
    category: 'teaching',
    tags: ['Student Engagement', 'Applied Learning', 'Relevance', 'Motivation'],
  },
  {
...
export const tools = [
  {
    ...
    category: 'teaching',
    tags: ['Writing Tools', 'Paraphrasing', 'Content Editing', 'Language Arts'],
  },
  {
    name: 'Lesson Plan',
    description:
  ...
  },
  {
    ...
    description: 'Take any text and translate it into any language instantly.',
    category: 'teaching',
  ...
  {
    name: 'BIP Generator',
    description: 'Generate suggestions for a Behavior Intervention Plan (BIP).',
    category: 'teaching',
