...
export default async function Layout({ children, params }: LayoutProps) {
  ...
  return (
    <div className="from-dynamic-light-red/10 via-dynamic-light-pink/5 to-dynamic-light-blue/10 flex h-screen max-h-screen min-h-screen flex-col overflow-y-auto bg-linear-to-br">
