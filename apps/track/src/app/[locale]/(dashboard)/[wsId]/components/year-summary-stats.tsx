...
export function YearSummaryStats({
  ...
  return (
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-4 lg:grid-cols-5">
      <Card className="border-0 bg-linear-to-br from-amber-50 to-amber-100 dark:from-amber-950/20 dark:to-amber-900/20">
      ...
      <Card className="border-0 bg-linear-to-br from-emerald-50 to-emerald-100 dark:from-emerald-950/20 dark:to-emerald-900/20">
        <CardContent className="p-4">
          <div className="flex items-center gap-3">
            <div className="rounded-full bg-white p-2 shadow-sm dark:bg-gray-800">
      ...
      <Card className="border-0 bg-linear-to-br from-violet-50 to-violet-100 dark:from-violet-950/20 dark:to-violet-900/20">
        <CardContent className="p-4">
          <div className="flex items-center gap-3">
            <div className="rounded-full bg-white p-2 shadow-sm dark:bg-gray-800">
      ...
      <Card className="border-0 bg-linear-to-br from-rose-50 to-rose-100 dark:from-rose-950/20 dark:to-rose-900/20">
        <CardContent className="p-4">
          <div className="flex items-center gap-3">
            <div className="rounded-full bg-white p-2 shadow-sm dark:bg-gray-800">
      ...
      <Card className="col-span-2 border-0 bg-linear-to-br from-indigo-50 to-indigo-100 sm:col-span-4 lg:col-span-1 dark:from-indigo-950/20 dark:to-indigo-900/20">
        <CardContent className="p-4">
          <div className="flex items-center gap-3">
            <div className="rounded-full bg-white p-2 shadow-sm dark:bg-gray-800">
