...
class HabitsCubit extends Cubit<HabitsState> {
  ...
  Future<void> loadWorkspace(String wsId, {bool refresh = false}) async {
    ...
    try {
      ...
      final response = await _repository.listTrackers(
        ...
        userId: state.selectedScope == HabitTrackerScope.member
      ...
      final nextMemberId = _resolveSelectedMemberId(
        scope: state.selectedScope,
        requestedMemberId: state.selectedMemberId,
        response: response,
      );
      ...
      if (state.selectedScope == HabitTrackerScope.member &&
