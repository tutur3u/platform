...
class WalletDetailTransactionCard extends StatelessWidget {
  const WalletDetailTransactionCard({
  ...
  Widget build(BuildContext context) {
    ...
    final walletCurrency = transaction.walletCurrency ?? workspaceCurrency;
    ...
    final takenAt = transaction.takenAt ?? transaction.createdAt;
    ...
    final amountText = isExpense
        ...
        : '+${formatCurrency(amount, walletCurrency)}';
    final safeConvertedAmount = convertedAmount ?? amount;
    final convertedSummaryText = safeConvertedAmount >= 0
        ? '≈ +${formatCurrency(safeConvertedAmount, workspaceCurrency)}'
        : '≈ ${formatCurrency(safeConvertedAmount, workspaceCurrency)}';
