...
import { BookText, Building, Zap } from '@tuturuuu/icons';
      ...
      <NavigationMenuList className="flex w-full justify-between">
        ...
        <NavigationMenuItem>
          <NavigationMenuTrigger className="group rounded-lg bg-transparent font-semibold transition-all duration-200 hover:bg-blue-50 hover:text-blue-700 dark:hover:bg-blue-950/20 dark:hover:text-blue-300">
            <span className="flex items-center gap-2">
              {t('common.solutions')}
              <span className="rounded-full bg-green-100 px-2 py-0.5 font-semibold text-green-700 text-xs dark:bg-green-900/20 dark:text-green-300">
                {t('common.new')}
              </span>
            </span>
          </NavigationMenuTrigger>
          ...
          <div className="relative">
            <div className="flex items-center gap-3">
              ...
              {badge && (
                <Badge
                  variant="secondary"
                  className="ml-auto flex-none animate-pulse bg-blue-100 font-semibold text-blue-700 text-xs dark:bg-blue-900/20 dark:text-blue-300"
                >
                  {badge}
                </Badge>
              )}
            </div>
            <p className="mt-2 line-clamp-2 text-muted-foreground text-sm leading-snug opacity-80 transition-opacity duration-200 group-hover:opacity-100">
              {children}
            </p>
          </div>
        </a>
