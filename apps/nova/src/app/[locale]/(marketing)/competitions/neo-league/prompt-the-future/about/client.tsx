            ...
            <TabsContent value="organizers">
              ...
              >
                {organizers.map((member, index) => (
                  <React.Fragment key={`team-member-${index + 1}`}>
            ...
            <TabsContent value="builders">
              ...
              >
                {platformBuilders.map((member, index) => (
                  <React.Fragment key={`platform-builder-${index + 1}`}>
            ...
            <TabsContent value="sponsors">
              ...
              >
                {sponsors.map((sponsor, index) => (
                  <React.Fragment key={`sponsor-${index + 1}`}>
            ...
            <TabsContent value="thanks">
              ...
              >
                {contributors.map((contributor, index) => (
                  <React.Fragment key={`contributor-${index + 1}`}>
