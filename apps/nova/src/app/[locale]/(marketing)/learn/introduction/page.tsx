...
const lessonData = {
  ...
  sections: [
    ...
    },
    {
      ...
      content:
        'Prompt engineering is crucial because it directly impacts the quality and usefulness of AI-generated content. Well-crafted prompts can significantly improve the accuracy, relevance, and coherence of AI outputs, making them more valuable for various applications.',
    },
    {
