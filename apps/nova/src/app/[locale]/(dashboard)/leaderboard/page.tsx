...
export default function LeaderboardPage() {
  ...
  const initialData = Array.from({ length: 50 }).map((_, i) => ({
    ...
    country: ['USA', 'UK', 'Canada', 'Germany', 'Japan', 'Vietnam', 'Australia', 'France'][i % 8],
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      >
        ...
        <h1 className="mb-3 text-4xl font-bold">Prompt Engineering Leaderboard</h1>
        <p className="text-muted-foreground">
          Track your ranking and see how you compare to other prompt engineers in the competition
        </p>
      </motion.div>
        ...
        <Card>
          <CardContent className="flex items-center justify-between p-6">
            <div>
              ...
              <h3 className="text-2xl font-bold">{topScore.toLocaleString()}</h3>
            </div>
            <div className="rounded-full bg-primary/10 p-2 text-primary">
