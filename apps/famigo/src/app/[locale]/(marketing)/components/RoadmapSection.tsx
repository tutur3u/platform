  ...
  return (
    <section id="roadmap" className="relative w-full py-24">
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="absolute top-1/3 left-0 h-[500px] w-[1px] bg-gradient-to-b from-transparent via-primary/20 to-transparent"></div>
        <div className="absolute top-2/3 right-0 h-[300px] w-[1px] bg-gradient-to-b from-transparent via-blue-500/20 to-transparent"></div>
      </div>
    </section>
  );
};
