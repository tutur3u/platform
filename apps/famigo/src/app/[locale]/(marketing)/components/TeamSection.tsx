...
const TeamSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="from-background absolute left-0 top-0 h-40 w-full bg-linear-to-b to-transparent"></div>
      <div className="from-background absolute bottom-0 left-0 h-40 w-full bg-linear-to-t to-transparent"></div>
