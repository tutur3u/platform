...
const TeamSection = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 h-40 w-full bg-gradient-to-b from-background to-transparent"></div>
      <div className="absolute bottom-0 left-0 h-40 w-full bg-gradient-to-t from-background to-transparent"></div>
