    ...
    >
      <Card className="border-foreground/10 bg-foreground/5 dark:border-foreground/5 dark:bg-foreground/10 h-full overflow-hidden backdrop-blur-sm">
        <div className="relative overflow-hidden rounded-xl p-6">
          ...
          <div className="from-background/20 via-foreground/5 to-background bg-linear-to-br absolute inset-0 opacity-0 transition-opacity duration-500 group-hover:opacity-100"></div>
