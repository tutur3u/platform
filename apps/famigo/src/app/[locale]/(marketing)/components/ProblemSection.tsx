...
const ProblemSection = () => {
  return (
    ...
    >
      {/* Background patterns */}
      <div className="bg-size-[14px_24px] pointer-events-none absolute inset-0 bg-[linear-gradient(to_right,rgba(var(--background-rgb),0.01)_1px,transparent_1px),linear-gradient(to_bottom,rgba(var(--background-rgb),0.01)_1px,transparent_1px)]"></div>
      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="relative mt-12 hidden md:block">
          <div className="right-1/6 left-1/6 via-foreground/10 bg-linear-to-r absolute top-0 h-px from-transparent to-transparent"></div>
          <div className="from-foreground/10 bg-linear-to-b absolute left-1/2 top-0 h-8 w-px -translate-x-1/2 to-transparent"></div>
