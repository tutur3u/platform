-- Harden the personal placement RPCs for local databases that already applied
-- the initial placement RPC migration before the direct-call auth check landed.
