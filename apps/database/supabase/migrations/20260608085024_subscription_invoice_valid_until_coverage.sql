-- Subscription coverage is based on the furthest completed valid_until date.
-- created_at is only a tie-breaker when two completed invoices cover the same boundary.
