-- Fix notify_task_updated vector comparison for pgvector builds without '=' support
...
COMMENT ON FUNCTION public.notify_task_updated IS 'Enhanced trigger function tracking task field changes. Fixes vector comparison by casting embedding to text before IS DISTINCT FROM checks.';
