-- Migration: enhance_transaction_rpc_details
-- Update get_wallet_transactions_with_permissions to return wallet name and creator details
...
RETURNS TABLE (
  ...
  wallet_id uuid,
  wallet_name text,           -- Added
  creator_full_name text,     -- Added
  creator_email text,         -- Added
  creator_avatar_url text,    -- Added
...
BEGIN
  ...
  RETURN QUERY EXECUTE format('
    SELECT
      ...
      wu.full_name as creator_full_name,
      wu.email as creator_email,
      wu.avatar_url as creator_avatar_url,
