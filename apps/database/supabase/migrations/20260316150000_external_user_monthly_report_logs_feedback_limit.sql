-- external_user_monthly_report_logs.feedback: increase from 512 to 65536
-- for user monthly report logs migration (follow-up when 20260316140000 was already applied)
