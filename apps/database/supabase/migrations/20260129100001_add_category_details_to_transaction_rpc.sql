-- Migration: add_category_details_to_transaction_rpc
-- Adds category_name, category_icon, and category_color to the transaction RPC return type

-- Drop the existing function to change its return type
