...
description: 'Understanding NCTHub CI/CD pipelines and automated workflows.'
---
...
NCTHub uses GitHub Actions for continuous integration and continuous deployment (CI/CD) across our monorepo. These automated workflows help us maintain code quality, run tests, and deploy our applications to various environments.

This page documents the key CI/CD pipelines used in the NCTHub platform and how they support our development workflow.
...
```yaml
name: Release @ncthub/types package
