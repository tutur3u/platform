...
The audio upload route is session-authenticated, requires `manage_drive`, checks
...
other models are loaded lazily when selected and exposed through `GET /models`.
