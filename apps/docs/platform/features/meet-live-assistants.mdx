...
speech. Explicit pause, interruption, mute, and session teardown still clear the
queue. Room transport preserves generation and sequence fences, stamps freshness
