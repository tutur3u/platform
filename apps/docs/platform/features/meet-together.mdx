---
title: 'Tuturuuu Meet'
description: 'Tuturuuu Meet helps you find and finalize the best time to meet with everyone.'
---
...
To use [Tuturuuu Meet](https://tuturuuu.com/meet), create a plan and invite participants with its canonical sharing link.
...
Workspace Meet plans are scoped to their owning workspace. A public workspace
plan link is shareable with workspace members, but it is not globally readable
by ID. Anonymous access is only valid for public plans that are not attached to
a workspace.
