...
- `/{wsId}/library`: content library and primary content editor
...
- The Library command center is the consolidated authoring entry point for entries, content models, workflow queues, and settings. Keep new CMS operations reachable from that surface before adding another isolated toolbar or settings panel.
