---
title: 'CMS'
description: 'Dedicated Tuturuuu CMS app for workspace content operations, schema-aware authoring, and root-level project linking.'
...
- `/play/{wsId}/webgl/{assetId}`: public WebGL package player. This route does not require a CMS login, but the proxied WebGL asset API still only serves the package when the owning CMS entry is published.
