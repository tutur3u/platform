...
3. Select the checkout mode matching the hardware: **Square POS app + Reader**
...
For standalone Terminal, Tuturuuu reserves stock and dispatches a Square Order
and Terminal checkout. For POS app + Reader, Tuturuuu reserves stock, opens the
Square POS app, and verifies the returned provider records before completion.
