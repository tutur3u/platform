...
- Square Terminal settings for OAuth/manual tokens, location selection, device
  pairing, webhook verification, and commerce actions that send, cancel, and
  reconcile terminal payments after local stock is reserved.
