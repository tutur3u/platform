...
list marks the task as completed for storage, reminders, and analytics, but the
task is not terminal and can still show the same done checkbox/action used by
active tasks.
