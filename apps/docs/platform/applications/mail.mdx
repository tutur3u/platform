...
identity, recipients, reply headers and attachments. The reader header omits its back
...
editor, collapsed by default, preserving its HTML when saving or sending. Selecting
