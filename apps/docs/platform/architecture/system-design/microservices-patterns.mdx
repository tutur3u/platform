...
|---------|----------|---------|----------|------------|
| **web** | `apps/web` | Main platform application | Supabase (PostgreSQL) | Next.js 15, React, tRPC |
| **rewise** | `apps/rewise` | AI-powered chatbot | Supabase (shared) | Next.js 15, AI SDK |
| **nova** | `apps/nova` | Prompt engineering platform | Supabase (shared) | Next.js 15, AI SDK |
| **calendar** | `apps/calendar` | Calendar & scheduling | Supabase (shared) | Next.js 15, React |
| **finance** | `apps/finance` | Finance management | Supabase (shared) | Next.js 15, React |
| **tudo** | `apps/tudo` | Task management (hierarchical) | Supabase (shared) | Next.js 15, React |
| **tumeet** | `apps/tumeet` | Meeting management | Supabase (shared) | Next.js 15, React |
| **shortener** | `apps/shortener` | URL shortener service | Supabase (shared) | Next.js 15 |
