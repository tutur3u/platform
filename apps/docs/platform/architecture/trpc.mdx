...
description: 'How to create and use tRPC routers in the NCT Hub platform'
updated: '2025-01-10'
---

The NCT Hub platform uses [tRPC](https://trpc.io/) for end-to-end type-safe API communication between the Next.js frontend and backend. This ensures type safety for club management operations, member interactions, and data synchronization.
