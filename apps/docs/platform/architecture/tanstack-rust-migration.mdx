...
`bun migration:tanstack:gates` with the Docker E2E compare report. Generated
benchmark and E2E reports stay under ignored `tmp/` paths.
...
7. Legacy `apps/web` remains available as the rollback fixture until production
