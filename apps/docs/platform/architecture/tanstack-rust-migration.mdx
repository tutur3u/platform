...
- `216` migrated artifacts, `299` terminal artifacts, and `1,219` remaining
...
| `GET /api/v1/internal/holidays`                                                                                                                               | Legacy-compatible public Vietnamese holiday list backed by the Rust server-owned Supabase REST adapter, including optional parseInt-style year filtering. POST/item/bulk admin holiday mutations remain legacy-owned.         |
