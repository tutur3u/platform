...
| ---------------------------------- | ------------------------------------------------------------------------- |
| `apps/backend/wrangler.jsonc`      | `BACKEND_INTERNAL_TOKEN`, `TUTURUUU_APP_COORDINATION_SECRET`, `CRON_SECRET`, `DISCORD_APP_DEPLOYMENT_URL` |
...
app. Wrangler prompts for values; do not place those values in `wrangler.jsonc`,
`vars`, docs, or shell history.
