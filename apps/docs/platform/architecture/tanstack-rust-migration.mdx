...
- `305` pages
- `67` layouts
- `1,127` route handler artifacts
- `19` cron handlers
- `1,504` total tracked route artifacts
- `134` migrated artifacts, `135` terminal artifacts, and `1,369` remaining
  legacy-owned artifacts after the current auth preflight method batch
