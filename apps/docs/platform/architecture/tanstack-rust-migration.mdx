...
- `306` pages
- `67` layouts
- `1,135` route handler artifacts
- `19` cron handlers
- `1,513` total tracked route artifacts
- `186` migrated artifacts, `269` terminal artifacts, and `1,244` remaining
...
- Bind `BACKEND_INTERNAL_TOKEN`, `BACKEND_PUBLIC_ORIGIN`, `SUPABASE_URL`,
  ...
  `DISCORD_APP_DEPLOYMENT_URL` with `wrangler secret put`,
