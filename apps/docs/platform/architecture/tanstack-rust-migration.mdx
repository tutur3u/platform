...
- `93` migrated artifacts, `94` terminal artifacts, and `1,395` remaining
  legacy-owned artifacts after the current static public-route batch
...
| `/:locale/women-in-tech`        | The page is public but still uses Next navigation/image behavior and posts language preference through the legacy app API.                                             | Replace Next-only primitives, keep language preference behind the migrated Rust cookie endpoint, and port assets/copy with public-route E2E coverage.                                                                                                      |
