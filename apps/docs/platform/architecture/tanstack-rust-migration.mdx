...
- `109` migrated artifacts, `110` terminal artifacts, and `1,379` remaining
  legacy-owned artifacts after the current dashboard redirect batch
...
| `redirects.ts`  | Legacy-compatible redirect destinations for public, auth, dashboard alias, QR, Mail, CMS, and education routes. |
