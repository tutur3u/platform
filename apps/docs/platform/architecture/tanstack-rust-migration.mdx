...
- `306` pages
- `67` layouts
- `1,172` route handler artifacts
- `19` cron handlers
- `1,550` total tracked route artifacts
- `361` migrated artifacts, `445` terminal artifacts, and `1,105` remaining
  legacy-owned artifacts in the checked manifest. The terminal total is made up
  of `361` migrated artifacts and `84` accepted removals.
...
Frontend pages now terminal after backend readiness:
