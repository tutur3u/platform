...
```typescript
import { generateCrossAppToken } from '@ncthub/auth/cross-app';
...
```typescript
import { verifyCrossAppToken } from '@ncthub/auth/cross-app';
...
```typescript
// middleware.ts
import { createDynamicClient } from '@ncthub/supabase/server';
