...
Local development can exercise unsupported-browser and UI paths without a
registered credential. Real WebAuthn ceremonies require a secure origin; use
`localhost` or HTTPS when testing real registration and sign-in flows.
