...
Workspace members with `use_ai_studio` can review Studio-metered runs, usage,
provider cost, and workspace credit status. Observability and execution do not
depend on a global or workspace Studio enablement switch.
