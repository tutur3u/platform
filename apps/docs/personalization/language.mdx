...
If you want to help us translate [Tuturuuu](https://tuturuuu.com) into your language, feel free to open a pull request on our [GitHub repository](https://github.com/tutur3u/platform) that contains the translation files for the language you want to contribute (e.g., `apps/web/locales/en/*.json` for English).
