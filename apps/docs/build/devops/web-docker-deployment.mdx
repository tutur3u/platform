...
web cron job `/api/cron/infrastructure/docker-recovery-alerts` can still send a
fallback SES email after Docker and the web app are reachable again. Both paths
