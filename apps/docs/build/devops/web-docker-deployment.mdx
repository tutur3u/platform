...
route allows credentialed browser requests from the configured CMS origin and
the CMS client reports per-file upload progress while the backend handles the
