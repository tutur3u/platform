...
Next and TanStack frontend origins used by the run, and the cutover gate rejects
missing, credentialed, invalid, or same-origin compare evidence before it can
satisfy terminal migration gates.
