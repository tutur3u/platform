...
`manage_workspace_secrets`. Manage `.env.github` as row-level env keys in that
vault, then use the vault's Verify action before activating the draft. Legacy
