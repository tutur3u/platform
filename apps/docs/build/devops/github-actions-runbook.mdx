...
`apps/backend` Rust service checks: formatting, locked dependency fetch,
Clippy, tests, Cloudflare Worker target validation, smoke reporter unit tests,
native binary build, and Docker image build.
