...
- `supabase-production.yaml` checks both the latest production Vercel result and a completed successful `main` staging migration for the same commit before running.
