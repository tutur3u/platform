...
[`tuturuuu.ts`](/Users/vhpx/Documents/GitHub/platform/tuturuuu.ts).

The reusable workflow
[`ci-check.yml`](/Users/vhpx/Documents/GitHub/platform/.github/workflows/ci-check.yml)
...
4. If it changes a docs-visible page, add that page to `apps/docs/mint.json`.
