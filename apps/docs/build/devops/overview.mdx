...
| --- | --- | --- |
| Web apps (`apps/web`, `apps/apps`, `apps/nova`, `apps/rewise`, `apps/calendar`, `apps/finance`, `apps/inventory`, `apps/meet`, `apps/tasks`, `apps/track`, `apps/shortener`) | `.github/workflows/vercel-*.yaml` | Vercel preview and production deployments |
